...
import{r as m,j as r,C as V,_ as ce,B as ze,S as Pe,M as Se,R as Ee,a as Ne}from"./vendor-react-DBlZ22TX.js";import{B as Le,p as je}from"./vendor-utils-DahDrsZr.js";import{r as Fe}from"./vendor-katex-CrEV6Ds-.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))n(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const o of c.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(l){if(l.ep)return;l.ep=!0;const c=t(l);fetch(l.href,c)}})();function Ae({chapters:s,currentChapter:e,bodyContent:t,onChapterSelect:n,currentScript:l,onScriptSelect:c,selectedTopicId:o,onTopicSelect:g,loading:b}){var k,d;const i=m.useMemo(()=>{const a=e==null?void 0:e.content;if(!a)return[];let f="";const u=a.intro;typeof u=="string"?f=u:u&&typeof u=="object"&&u.body&&(f+=typeof u.body=="string"?u.body:Object.values(u.body).join(`
`));const x=t||a.body;if(x&&(typeof x=="string"?f+=`
`+x:Array.isArray(x)?f+=`
`+x.join(`
`):typeof x=="object"&&(f+=`
`+Object.values(x).join(`
`))),!f)return[];const L=/^###\s+(.+)$/gm,F=[];let M;for(;(M=L.exec(f))!==null;){const C=M[1].trim(),D="topic-"+C.replace(/\s+/g,"-").toLowerCase();F.push({id:D,title:C})}return F},[e,t]);return r.jsxs("div",{className:"top-nav-container",children:[r.jsx("div",{className:"nav-group",children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:a=>{const f=s.find(u=>u.id===a.target.value);f&&n(f)},disabled:b||s.length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:b?"載入中...":"📖 章節選擇"}),s.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(V,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${!e||i.length===0?"disabled":""}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"topic-select",name:"topic-select",value:o,onChange:a=>g(a.target.value),disabled:!e||i.length===0,className:"custom-select",children:[r.jsx("option",{value:"",children:"💡 重點導覽"}),i.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(V,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"script-select",name:"script-select",value:(l==null?void 0:l.filename)||"",onChange:a=>{var u;const f=(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples);if(f){const x=f.find(L=>L.filename===a.target.value);x&&c(x)}},disabled:!e||!(e.examples||(k=e.content)!=null&&k.examples)||(e.examples||((d=e.content)==null?void 0:d.examples)||[]).length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var u;return[...(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples)||[]].sort((x,L)=>x.filename.localeCompare(L.filename,void 0,{numeric:!0,sensitivity:"base"})).map(x=>r.jsx("option",{value:x.filename,children:x.filename},x.filename))})()]}),r.jsx(V,{className:"select-icon",size:16})]})})]})}const Ce=new Le,Re=m.memo(({chapter:s,bodyContent:e,onCodeClick:t,selectedTopicId:n,output:l,isRunning:c,plotImages:o})=>{const g=m.useRef(null),b=m.useMemo(()=>{var k,d;if(!s)return null;const i=(k=s.content)==null?void 0:k.intro;if(i){let a="";if(typeof i=="string")a=i;else if(typeof i=="object"){a=`# ${i.title||""}
...
`,typeof v=="string"){let y=null;try{v.trim().startsWith("{")&&(y=JSON.parse(v))}catch{}y&&typeof y=="object"?a+=Object.values(y).join(`
...
`);const f=[];a=a.replace(/\$\$([\s\S]*?)\$\$/g,(v,y)=>{const E=f.length;return f.push({type:"display",content:y}),` @@MATH_BLOCK_${E}@@ `}),a=a.replace(/\\begin\{aligned\}([\s\S]*?)\\end\{aligned\}/g,(v,y)=>{const E=f.length;return f.push({type:"display",content:`\\begin{aligned}${y}\\end{aligned}`}),` @@MATH_BLOCK_${E}@@ `}),a=a.replace(new RegExp("(?<!\\\\)\\$([^$\\n]+?)\\$","g"),(v,y)=>{const E=f.length;return f.push({type:"inline",content:y}),` @@MATH_BLOCK_${E}@@ `});let x=Ce.parse(a).replace(/<h3>(.*?)<\/h3>/g,(v,y)=>`<h3 id="${"topic-"+y.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${y}</h3>`);const L=je.sanitize(x,{USE_PROFILES:{html:!0,mathml:!0},ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename","encoding","display"]}),M=[...s.examples||[]].sort((v,y)=>y.filename.length-v.filename.length);let C=L;return M.forEach(v=>{const y=v.filename.replace(".","\\."),E=new RegExp(`(?<!['".\\w])(${y})(?!['".\\w])`,"g");C=C.replace(E,`<span class="code-link" data-filename="${v.filename}">${v.filename}</span>`)}),C.replace(/@@MATH_BLOCK_(\d+)@@/g,(v,y)=>{const E=f[parseInt(y)];return E.type==="display"?`\\[ ${E.content.trim()} \\]`:`\\( ${E.content.trim()} \\)`})}else{const a=s.examples||[];let f=`
        <div class="chapter-intro">
          <h2>${s.title}</h2>
          <p>本章包含 ${a.length} 個程式範例</p>
          <div class="example-grid">
      `;return a.forEach((u,x)=>{f+=`
      ...
      `,f}},[s,e]);return m.useEffect(()=>{const i=k=>{if(k.target.classList.contains("code-link")){const d=k.target.dataset.filename;let a=null;s!=null&&s.examples&&(a=s.examples.find(f=>f.filename===d),a&&!a.metadata&&(a.metadata={description:a.title})),a&&t(a)}};return document.addEventListener("click",i),()=>document.removeEventListener("click",i)},[s,t]),m.useEffect(()=>{const i=document.querySelector(".content-scroll");i&&(i.scrollTop=0)},[s]),m.useEffect(()=>{g.current&&b&&Fe(g.current,{delimiters:[{left:"$$",right:"$$",display:!0},{left:"$",right:"$",display:!1},{left:"\\(",right:"\\)",display:!1},{left:"\\[",right:"\\]",display:!0}],throwOnError:!1,strict:"ignore"})},[b]),m.useEffect(()=>{if(n){const i=document.getElementById(n);i&&i.scrollIntoView({behavior:"smooth",block:"start"})}},[n]),m.useEffect(()=>{if(l||o&&o.length>0||c){const i=document.querySelector(".content-scroll");i&&i.scrollTo({top:0,behavior:"instant"})}},[l,o,c]),r.jsx("div",{className:"content-panel",children:r.jsx("div",{className:"content-scroll",children:l||o&&o.length>0||c?r.jsxs("div",{id:"execution-output",className:"execution-output-section",children:[c&&r.jsxs("div",{className:"running-indicator",children:[r.jsx("div",{className:"spinner"}),r.jsx("span",{children:"程式執行中..."})]}),l&&r.jsx("pre",{className:"output-text",children:l}),o&&o.length>0&&r.jsx("div",{className:"output-images",children:o.map((i,k)=>r.jsx("div",{className:"output-image",children:r.jsx("img",{src:i,alt:`Plot ${k+1}`})},k))})]}):b?r.jsx("div",{ref:g,className:"markdown-body",dangerouslySetInnerHTML:{__html:b}}):r.jsx("div",{className:"welcome-screen",children:r.jsxs("div",{className:"welcome-card premium-welcome",children:[r.jsxs("div",{className:"welcome-brand",children:[r.jsx("img",{src:"book-cover.jpg",alt:"FRM Python 理論與實戰",className:"welcome-book-img"}),r.jsx("a",{href:"https://deepwisdom.com.tw/product/%e6%89%8b%e8%a1%93%e5%88%80%e8%88%ac%e7%b2%be%e6%ba%96%e7%9a%84frm-%e7%94%a8python%e7%a7%91%e5%ad%b8%e7%ae%a1%e6%8e%a7%e8%b2%a1%e9%87%91%e9%a2%a8%e9%9a%aa%e5%9f%ba%e7%a4%8e%e7%af%87dm2301/",target:"_blank",rel:"noopener noreferrer",className:"welcome-purchase-btn",children:"[ 本書官網購買連結 ]"})]}),r.jsxs("div",{className:"welcome-content",children:[r.jsxs("h2",{className:"welcome-title",children:["手術刀般精準的 FRM 用 Python",r.jsx("br",{}),"科學管控財金風險：基礎篇"]}),r.jsx("div",{className:"welcome-slogan",children:"☆★☆★【有如手術刀般精準！利用Python幫你管控財金風險！】★☆★☆"}),r.jsxs("div",{className:"welcome-text-scroll",children:[r.jsx("p",{children:"本書使用了當紅的程式語言 Python，從程式設計的基本觀念談起。沒有 Python 基礎也沒關係，完整的 Python 介紹，讓您能順利銜接資料科學家最常用的套件整理，包括 Numpy，以及特別針對格式化表格類處理的 Pandas，也充分介紹了 Dataframe 的各種應用。"}),r.jsx("p",{children:"在有了充足的資料之後，接著需要有可以展示數據的工具。除了大家最愛用的 Matplotlib 之外，也介紹了高手才會用的 Seaborn。當熟悉了工具之後，就正式進入了金融理論，包括基礎的機率及統計、各種模型及機率分佈，以及抽樣、信賴區間等內容說明。"}),r.jsx("p",{children:"最後則進入到金融領域，除了介紹各種計算的演算法、模型、術語，也結合了前面所學的 Python 及工具，並講解金融商品最重要的「固定收益分析」。"}),r.jsx("p",{children:"本書從科學下手，讓您精準了解金融原理，確保金錢不再陷入水深火熱之中，將是您從科學到金融領域最重要的橋樑。"})]})]})]})})})})});function Me(){return null}function $e(s={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:n,onRegistered:l,onRegisteredSW:c,onRegisterError:o}=s;let g,b,i;const k=async(a=!0)=>{await b,i==null||i()};async function d(){if("serviceWorker"in navigator){if(g=await ce(async()=>{const{Workbox:a}=await import("./vendor-B3CQIlJd.js").then(f=>f.w);return{Workbox:a}},[]).then(({Workbox:a})=>new a("/pwa_FRM_Book1_python/sw.js",{scope:"/pwa_FRM_Book1_python/",type:"classic"})).catch(a=>{o==null||o(a)}),!g)return;i=()=>{g==null||g.messageSkipWaiting()};{let a=!1;const f=()=>{a=!0,g==null||g.addEventListener("controlling",u=>{u.isUpdate&&window.location.reload()}),t==null||t()};g.addEventListener("installed",u=>{typeof u.isUpdate>"u"?typeof u.isExternal<"u"&&u.isExternal?f():!a&&(n==null||n()):u.isUpdate||n==null||n()}),g.addEventListener("waiting",f)}g.register({immediate:e}).then(a=>{c?c("/pwa_FRM_Book1_python/sw.js",a):l==null||l(a)}).catch(a=>{o==null||o(a)})}}return b=d(),k}function Te(s={}){const{immediate:e=!0,onNeedRefresh:t,onOfflineReady:n,onRegistered:l,onRegisteredSW:c,onRegisterError:o}=s,[g,b]=m.useState(!1),[i,k]=m.useState(!1),[d]=m.useState(()=>$e({immediate:e,onOfflineReady(){k(!0),n==null||n()},onNeedRefresh(){b(!0),t==null||t()},onRegistered:l,onRegisteredSW:c,onRegisterError:o}));return{needRefresh:[g,b],offlineReady:[i,k],updateServiceWorker:d}}function De(){const{offlineReady:[s,e],needRefresh:[t,n],updateServiceWorker:l}=Te({onRegisteredSW(o,g){console.debug(`Service Worker at: ${o}`),g&&setInterval(()=>{g.update()},36e5)},onRegisterError(o){console.warn("SW registration error",o)}}),c=()=>{e(!1),n(!1)};return r.jsx("div",{className:"ReloadPrompt-container",children:(s||t)&&r.jsxs("div",{className:"ReloadPrompt-toast",children:[r.jsx("div",{className:"ReloadPrompt-message",children:s?"App ready to work offline":"New content available, click on reload button to update."}),t&&r.jsx("button",{className:"ReloadPrompt-toast-button",onClick:()=>l(!0),children:"Reload"}),r.jsx("button",{className:"ReloadPrompt-toast-button",onClick:c,children:"Close"})]})})}function Be(s){const[e,t]=m.useState(null),[n,l]=m.useState(!1),c=m.useRef({});return m.useEffect(()=>{if(!s){t(null);return}const o=s.content,g=s.id;if(o!=null&&o.body&&!(o!=null&&o.bodyRef)){t(o.body);return}const b=o==null?void 0:o.bodyRef;if(!b||!Array.isArray(b)||b.length===0){t(null);return}let i=!1;return l(!0),(async()=>{const d={};await Promise.all(b.map(async a=>{const f=`${g}/${a}`;if(c.current[f]!==void 0){d[a]=c.current[f];return}try{const u=`/pwa_FRM_Book1_python/data/modular/${g}/${a}.json`,x=await fetch(u);if(!x.ok)throw new Error(`HTTP ${x.status}`);const F=(await x.json()).content||"";c.current[f]=F,d[a]=F}catch(u){console.warn(`[useBodyContent] Failed to load ${g}/${a}:`,u),d[a]=""}})),i||(t(d),l(!1))})(),()=>{i=!0}},[s]),{bodyContent:e,bodyLoading:n}}const pe=`
# QuantLib (ql) 強大模擬層
...
try:
    ...
    for func in ['irr', 'npv', 'pmt', 'pv', 'rate', 'nper', 'fv', 'ppmt', 'ipmt']:
        if not hasattr(np, func) and hasattr(npf, func): setattr(np, func, getattr(npf, func))
                ...
                `)]),await e.yieldToUI(),e.update(95,"🔬 系統：正在安裝 SciPy 純 Python 計算引擎..."),await e.yieldToUI(),await t.runPythonAsync(Qe),e.update(98,"🚀 系統：正在啟動 Pymoo & QuantLib 虛擬層..."),await e.yieldToUI(),await Promise.all([t.runPythonAsync(We),t.runPythonAsync(Ie),t.runPythonAsync(pe),t.runPythonAsync(me),t.runPythonAsync(Oe)]),e.update(99,"🛡️ 系統：權限校正與輸入掛鉤注入..."),await t.runPythonAsync(`
import builtins
import js
def custom_input(prompt = ""):
    try:
...
builtins.input = custom_input
            `),await e.yieldToUI(),Y=t,T=null,e.finish("載入完成！正在進入主介面..."),t}catch(t){throw T=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),T)}async function Ke(s,e,t=3e4){let n;const l=new Promise((c,o)=>{n=setTimeout(()=>{o(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([s.runPythonAsync(e),l])}finally{clearTimeout(n)}}async function Je(s){if(s)try{await s.runPythonAsync(`
            import gc
import matplotlib.pyplot as plt
            plt.close('all')
            gc.collect()
...
try:
    ...
    pass
      `)}catch{}return t}catch(e){return console.error("Failed to capture plots:",e),[]}}async function ie(s,e=!1){try{const t=e?"module://matplotlib_pyodide.wasm_backend":"AGG";await s.runPythonAsync(`
import matplotlib
import matplotlib.pyplot as plt
import warnings
import io
...
await micropip.install(${JSON.stringify(w)}, keep_going=True)
          `)),j.includes("pandas_datareader")&&await s.runPythonAsync(me),j.includes("matplotlib")&&(await ie(s),X||ee("AGG")),j.forEach(S=>{$.add(S);const N=K[S];N&&!N.endsWith(".whl")&&$.add(N)}),p||y(S=>S+`✅ 套件載入完成。
`)}catch(h){if(console.warn("Dependency loading failed:",h),window.failedPackages||(window.failedPackages=new Set),j.forEach(w=>window.failedPackages.add(w)),!p){const w=h.message||String(h);if(w.includes("Can't find a pure Python 3 wheel")){const S=((ne=w.match(/for: '([^']+)'/))==null?void 0:ne[1])||"unknown";y(N=>N+`⚠️ 套件 "${S}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else y(S=>S+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},he=async _=>{if(!(!s||W||!_)){U(!0),y(`執行中...
`),R([]);try{a&&a.id&&await le(s,a.id),await ae(_),I.start("run-code"),await Je(s);const p=_.includes("matplotlib.widgets")||_.includes("Slider")||_.includes("Button");ue(p);const q=p?"module://matplotlib_pyodide.wasm_backend":"AGG";if(X!==q&&(await ie(s,p),ee(q)),await s.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),p){const P=document.getElementById("pyodide-plot-container");P&&(P.innerHTML="",window.document.pyodideMplTarget=P)}try{await Ke(s,_)}catch(P){const j=await s.runPythonAsync("sys.stdout.getvalue()"),B=oe(P);y((j?j+`
`:"")+B),U(!1),I.end("run-code");return}const z=await s.runPythonAsync("sys.stdout.getvalue()");if(y(z||"執行完成（無文字內容輸出 ）"),J)await et(s);else{const P=await Xe(s);R(P)}}catch(p){const q=oe(p);y(q),console.error(p)}finally{U(!1),I.end("run-code")}}},xe=async _=>{let p=_;if(_&&!_.content&&(p=await ge(_.id)),!!p&&(f(p),x(null),F(""),y(""),R([]),p&&p.examples&&s)){const q=p.examples.map(z=>z.code).join(`
`);ae(q,!0)}};m.useEffect(()=>{s&&a&&a.id&&le(s,a.id).catch(_=>console.error("Dataset lazy load failed",_))},[s,a]);const be=_=>{x(_),y(""),R([])},ve=_=>{x(_),y(""),R([])},we=()=>{x(null),y(""),R([])},ke=t;return r.jsxs("div",{className:`app ${A?"dark":""}`,children:[r.jsxs("div",{className:"main-content",children:[r.jsxs("div",{className:"top-bar",children:[r.jsxs("div",{className:"top-bar-left",children:[r.jsx(ze,{size:20,className:"logo-icon"}),r.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),r.jsx(Ae,{chapters:b,currentChapter:a,bodyContent:D,onChapterSelect:xe,currentScript:u,onScriptSelect:ve,selectedTopicId:L,onTopicSelect:F,loading:k}),r.jsx("div",{className:"top-bar-right",children:r.jsx("button",{className:"theme-toggle",onClick:()=>_e(!A),title:A?"切換到亮色模式":"切換到暗色模式",children:A?r.jsx(Pe,{size:20}):r.jsx(Se,{size:20})})})]}),ke&&r.jsx("div",{className:"hydration-overlay",children:r.jsxs("div",{className:"hydration-card",children:[r.jsxs("div",{className:"hydration-header",children:[r.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),r.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),r.jsx("div",{className:"hydration-progress-container",children:r.jsx("div",{className:"hydration-progress-bar",style:{width:`${l}%`}})}),r.jsxs("div",{className:"hydration-status",children:[r.jsx("span",{children:o}),r.jsxs("span",{children:[l,"%"]})]})]})}),r.jsxs("div",{className:"panes-container",children:[r.jsx("div",{className:"content-pane",children:r.jsx(Re,{chapter:a,bodyContent:D,onCodeClick:be,selectedTopicId:L,darkMode:A,output:v,isRunning:W,plotImages:E,onClearOutput:()=>{y(""),R([])}})}),u&&r.jsx("div",{className:"preview-pane",style:{width:`${Z}px`},children:r.jsx(m.Suspense,{fallback:r.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:r.jsx(st,{script:u,onClose:we,onRun:he,isRunning:W,isLoading:t,output:v,images:E,isInteractive:J,darkMode:A,width:Z,onResize:ye})})})]})]}),r.jsx(Me,{pyodide:s}),r.jsx(De,{})]})}async function rt(){try{if(!("serviceWorker"in navigator))return;const s="frm_sw_cleanup_done_v1";if(localStorage.getItem(s))return;if(!navigator.serviceWorker.controller){localStorage.setItem(s,"1");return}console.info("[AUTO-CLEAN] Detected active Service Worker — cleaning caches and storage.");try{const e=await navigator.serviceWorker.getRegistrations();await Promise.all(e.map(t=>t.unregister().catch(()=>{}))),console.info("[AUTO-CLEAN] serviceWorker registrations unregistered.")}catch(e){console.warn("[AUTO-CLEAN] Failed to unregister service workers",e)}try{if("caches"in window){const e=await caches.keys();await Promise.all(e.map(t=>caches.delete(t).catch(()=>{}))),console.info("[AUTO-CLEAN] CacheStorage cleared:",e)}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear CacheStorage",e)}try{if("databases"in indexedDB){const e=await indexedDB.databases();await Promise.all(e.map(t=>indexedDB.deleteDatabase(t.name).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB databases deleted:",e.map(t=>t.name))}else{const e=["pyodide","emscripten-archives","idb-filesystem","file_storage"];await Promise.all(e.map(t=>indexedDB.deleteDatabase(t).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB fallback delete attempted for candidates.")}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear IndexedDB",e)}try{localStorage.clear(),sessionStorage.clear(),console.info("[AUTO-CLEAN] localStorage and sessionStorage cleared.")}catch(e){console.warn("[AUTO-CLEAN] Failed to clear storage",e)}try{localStorage.setItem(s,"1")}catch{}try{console.info("[AUTO-CLEAN] Reloading page to load fresh assets."),window.location.reload(!0)}catch(e){console.info("[AUTO-CLEAN] Reload skipped.",e)}}catch(s){console.warn("[AUTO-CLEAN] Unexpected error",s)}}rt().catch(()=>{});Ee.createRoot(document.getElementById("root")).render(r.jsx(Ne.StrictMode,{children:r.jsx(nt,{})}));
