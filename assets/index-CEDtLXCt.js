...
import{r as m,j as r,C as V,_ as ce,B as ze,S as Pe,M as Se,R as Ee,a as Le}from"./vendor-react-DBlZ22TX.js";import{B as Ne,p as je}from"./vendor-utils-DahDrsZr.js";import{r as Fe}from"./vendor-katex-CrEV6Ds-.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))n(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const o of c.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(l){if(l.ep)return;l.ep=!0;const c=t(l);fetch(l.href,c)}})();function Ae({chapters:s,currentChapter:e,bodyContent:t,onChapterSelect:n,currentScript:l,onScriptSelect:c,selectedTopicId:o,onTopicSelect:y,loading:b}){var k,d;const i=m.useMemo(()=>{const a=e==null?void 0:e.content;if(!a)return[];let f="";const u=a.intro;typeof u=="string"?f=u:u&&typeof u=="object"&&u.body&&(f+=typeof u.body=="string"?u.body:Object.values(u.body).join(`
`));const x=t||a.body;if(x&&(typeof x=="string"?f+=`
`+x:Array.isArray(x)?f+=`
`+x.join(`
`):typeof x=="object"&&(f+=`
`+Object.values(x).join(`
`))),!f)return[];const N=/^###\s+(.+)$/gm,F=[];let $;for(;($=N.exec(f))!==null;){const R=$[1].trim(),B="topic-"+R.replace(/\s+/g,"-").toLowerCase();F.push({id:B,title:R})}return F},[e,t]);return r.jsxs("div",{className:"top-nav-container",children:[r.jsx("div",{className:"nav-group",children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:a=>{const f=s.find(u=>u.id===a.target.value);f&&n(f)},disabled:b||s.length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:b?"載入中...":"📖 章節選擇"}),s.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(V,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${!e||i.length===0?"disabled":""}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"topic-select",name:"topic-select",value:o,onChange:a=>y(a.target.value),disabled:!e||i.length===0,className:"custom-select",children:[r.jsx("option",{value:"",children:"💡 重點導覽"}),i.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(V,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"script-select",name:"script-select",value:(l==null?void 0:l.filename)||"",onChange:a=>{var u;const f=(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples);if(f){const x=f.find(N=>N.filename===a.target.value);x&&c(x)}},disabled:!e||!(e.examples||(k=e.content)!=null&&k.examples)||(e.examples||((d=e.content)==null?void 0:d.examples)||[]).length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var u;return[...(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples)||[]].sort((x,N)=>x.filename.localeCompare(N.filename,void 0,{numeric:!0,sensitivity:"base"})).map(x=>r.jsx("option",{value:x.filename,children:x.filename},x.filename))})()]}),r.jsx(V,{className:"select-icon",size:16})]})})]})}const Re=new Ne,Ce=m.memo(({chapter:s,bodyContent:e,onCodeClick:t,selectedTopicId:n,output:l,isRunning:c,plotImages:o})=>{const y=m.useRef(null),b=m.useMemo(()=>{var k,d;if(!s)return null;const i=(k=s.content)==null?void 0:k.intro;if(i){let a="";if(typeof i=="string")a=i;else if(typeof i=="object"){a=`# ${i.title||""}
...
`)}const z=["sys","os","io","time","timeit","base64","json","datetime","math","re","warnings","builtins","types","random","csv","copy","collections","itertools","functools","pathlib","fractions","struct","operator","string","decimal","abc","enum","typing","textwrap"],P=["numpy","pandas","matplotlib","micropip","js","builtins","QuantLib","mcint","arch","mibian"],j=[...new Set(q.map(h=>{const w=h.trim().split(/\s+/);return w[0]==="from",w[1].split(".")[0]}))].filter(h=>!z.includes(h)&&!P.includes(h)).filter(h=>{var w;return!M.has(h)&&!((w=window.failedPackages)!=null&&w.has(h))});if(j.length===0)return;const D=[],O=[],H=new URL("/pwa_FRM_Book1_python/",window.location.origin).href,qe=new Set(["scipy","statsmodels","scikit-learn","sympy"]),Q=h=>{if(h){if(typeof h=="string"&&(h.endsWith(".whl")||h.startsWith("http"))){O.push(h);return}qe.has(h)?D.push(h):O.push(h)}},se={sklearn:["scipy","scikit-learn"],"scikit-learn":["scipy"],statsmodels:["scipy"],sympy:[],seaborn:["matplotlib","pandas","scipy","statsmodels"],pandas_datareader:["requests"]};if(j.forEach(h=>{const w=K[h];w?(Q(w.endsWith(".whl")?H+w:w),(de[h]||[]).forEach(L=>{const G=de[L]||L;Q(G.endsWith(".whl")?H+G:G)})):Q(h),se[h]&&se[h].forEach(S=>{if(!M.has(S)&&!P.includes(S)){const L=K[S]||S;Q(L.endsWith(".whl")?H+L:L)}})}),D.length>0||O.length>0)try{const h=[...new Set(D)],w=[...new Set(O)];p||g(S=>S+`正在動態載入所需套件 [${j.join(", ")}]...
...
`),C([]);try{a&&a.id&&await le(s,a.id),await ae(_),I.start("run-code"),await Je(s);const p=_.includes("matplotlib.widgets")||_.includes("Slider")||_.includes("Button");ue(p);const q=p?"module://matplotlib_pyodide.wasm_backend":"AGG";if(X!==q&&(await ie(s,p),ee(q)),await s.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),p){const P=document.getElementById("pyodide-plot-container");P&&(P.innerHTML="",window.document.pyodideMplTarget=P)}try{await Ke(s,_)}catch(P){const j=await s.runPythonAsync("sys.stdout.getvalue()"),D=oe(P);g((j?j+`
`:"")+D),U(!1),I.end("run-code");return}const z=await s.runPythonAsync("sys.stdout.getvalue()");if(g(z||"執行完成（無文字內容輸出 ）"),J)await et(s);else{const P=await Xe(s);C(P)}}catch(p){const q=oe(p);g(q),console.error(p)}finally{U(!1),I.end("run-code")}}},xe=async _=>{let p=_;if(_&&!_.content&&(p=await ye(_.id)),!!p&&(f(p),x(null),F(""),g(""),C([]),p&&p.examples&&s)){const q=p.examples.map(z=>z.code).join(`
`);ae(q,!0)}};m.useEffect(()=>{s&&a&&a.id&&le(s,a.id).catch(_=>console.error("Dataset lazy load failed",_))},[s,a]);const be=_=>{x(_),g(""),C([])},ve=_=>{x(_),g(""),C([])},we=()=>{x(null),g(""),C([])},ke=t;return r.jsxs("div",{className:`app ${A?"dark":""}`,children:[r.jsxs("div",{className:"main-content",children:[r.jsxs("div",{className:"top-bar",children:[r.jsxs("div",{className:"top-bar-left",children:[r.jsx(ze,{size:20,className:"logo-icon"}),r.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),r.jsx(Ae,{chapters:b,currentChapter:a,bodyContent:B,onChapterSelect:xe,currentScript:u,onScriptSelect:ve,selectedTopicId:N,onTopicSelect:F,loading:k}),r.jsx("div",{className:"top-bar-right",children:r.jsx("button",{className:"theme-toggle",onClick:()=>_e(!A),title:A?"切換到亮色模式":"切換到暗色模式",children:A?r.jsx(Pe,{size:20}):r.jsx(Se,{size:20})})})]}),ke&&r.jsx("div",{className:"hydration-overlay",children:r.jsxs("div",{className:"hydration-card",children:[r.jsxs("div",{className:"hydration-header",children:[r.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),r.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),r.jsx("div",{className:"hydration-progress-container",children:r.jsx("div",{className:"hydration-progress-bar",style:{width:`${l}%`}})}),r.jsxs("div",{className:"hydration-status",children:[r.jsx("span",{children:o}),r.jsxs("span",{children:[l,"%"]})]})]})}),r.jsxs("div",{className:"panes-container",children:[r.jsx("div",{className:"content-pane",children:r.jsx(Ce,{chapter:a,bodyContent:B,onCodeClick:be,selectedTopicId:N,darkMode:A,output:v,isRunning:W,plotImages:E,onClearOutput:()=>{g(""),C([])}})}),u&&r.jsx("div",{className:"preview-pane",style:{width:`${Z}px`},children:r.jsx(m.Suspense,{fallback:r.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:r.jsx(st,{script:u,onClose:we,onRun:he,isRunning:W,isLoading:t,output:v,images:E,isInteractive:J,darkMode:A,width:Z,onResize:ge})})})]})]}),r.jsx($e,{pyodide:s}),r.jsx(Be,{})]})}async function rt(){try{if(!("serviceWorker"in navigator))return;const s="frm_sw_cleanup_done_v1";if(localStorage.getItem(s))return;if(!navigator.serviceWorker.controller){localStorage.setItem(s,"1");return}console.info("[AUTO-CLEAN] Detected active Service Worker — cleaning caches and storage.");try{const e=await navigator.serviceWorker.getRegistrations();await Promise.all(e.map(t=>t.unregister().catch(()=>{}))),console.info("[AUTO-CLEAN] serviceWorker registrations unregistered.")}catch(e){console.warn("[AUTO-CLEAN] Failed to unregister service workers",e)}try{if("caches"in window){const e=await caches.keys();await Promise.all(e.map(t=>caches.delete(t).catch(()=>{}))),console.info("[AUTO-CLEAN] CacheStorage cleared:",e)}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear CacheStorage",e)}try{if("databases"in indexedDB){const e=await indexedDB.databases();await Promise.all(e.map(t=>indexedDB.deleteDatabase(t.name).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB databases deleted:",e.map(t=>t.name))}else{const e=["pyodide","emscripten-archives","idb-filesystem","file_storage"];await Promise.all(e.map(t=>indexedDB.deleteDatabase(t).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB fallback delete attempted for candidates.")}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear IndexedDB",e)}try{localStorage.clear(),sessionStorage.clear(),console.info("[AUTO-CLEAN] localStorage and sessionStorage cleared.")}catch(e){console.warn("[AUTO-CLEAN] Failed to clear storage",e)}try{localStorage.setItem(s,"1")}catch{}try{console.info("[AUTO-CLEAN] Reloading page to load fresh assets."),window.location.reload(!0)}catch(e){console.info("[AUTO-CLEAN] Reload skipped.",e)}}catch(s){console.warn("[AUTO-CLEAN] Unexpected error",s)}}rt().catch(()=>{});Ee.createRoot(document.getElementById("root")).render(r.jsx(Le.StrictMode,{children:r.jsx(nt,{})}));
