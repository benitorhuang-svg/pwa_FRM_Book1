...
import{r as m,j as r,C as G,_ as ce,B as ze,S as Pe,M as Se,R as Ee,a as Le}from"./vendor-react-DBlZ22TX.js";import{B as Ne,p as je}from"./vendor-utils-DahDrsZr.js";import{r as Fe}from"./vendor-katex-CrEV6Ds-.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))n(l);new MutationObserver(l=>{for(const f of l)if(f.type==="childList")for(const o of f.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(l){const f={};return l.integrity&&(f.integrity=l.integrity),l.referrerPolicy&&(f.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?f.credentials="include":l.crossOrigin==="anonymous"?f.credentials="omit":f.credentials="same-origin",f}function n(l){if(l.ep)return;l.ep=!0;const f=t(l);fetch(l.href,f)}})();function Ae({chapters:s,currentChapter:e,bodyContent:t,onChapterSelect:n,currentScript:l,onScriptSelect:f,selectedTopicId:o,onTopicSelect:y,loading:b}){var k,c;const i=m.useMemo(()=>{const a=e==null?void 0:e.content;if(!a)return[];let d="";const u=a.intro;typeof u=="string"?d=u:u&&typeof u=="object"&&u.body&&(d+=typeof u.body=="string"?u.body:Object.values(u.body).join(`
`));const x=t||a.body;if(x&&(typeof x=="string"?d+=`
`+x:Array.isArray(x)?d+=`
`+x.join(`
`):typeof x=="object"&&(d+=`
`+Object.values(x).join(`
`))),!d)return[];const N=/^###\s+(.+)$/gm,F=[];let $;for(;($=N.exec(d))!==null;){const R=$[1].trim(),D="topic-"+R.replace(/\s+/g,"-").toLowerCase();F.push({id:D,title:R})}return F},[e,t]);return r.jsxs("div",{className:"top-nav-container",children:[r.jsx("div",{className:"nav-group",children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:a=>{const d=s.find(u=>u.id===a.target.value);d&&n(d)},disabled:b||s.length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:b?"載入中...":"📖 章節選擇"}),s.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(G,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${!e||i.length===0?"disabled":""}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"topic-select",name:"topic-select",value:o,onChange:a=>y(a.target.value),disabled:!e||i.length===0,className:"custom-select",children:[r.jsx("option",{value:"",children:"💡 重點導覽"}),i.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(G,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"script-select",name:"script-select",value:(l==null?void 0:l.filename)||"",onChange:a=>{var u;const d=(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples);if(d){const x=d.find(N=>N.filename===a.target.value);x&&f(x)}},disabled:!e||!(e.examples||(k=e.content)!=null&&k.examples)||(e.examples||((c=e.content)==null?void 0:c.examples)||[]).length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var u;return[...(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples)||[]].sort((x,N)=>x.filename.localeCompare(N.filename,void 0,{numeric:!0,sensitivity:"base"})).map(x=>r.jsx("option",{value:x.filename,children:x.filename},x.filename))})()]}),r.jsx(G,{className:"select-icon",size:16})]})})]})}const Re=new Ne,Ce=m.memo(({chapter:s,bodyContent:e,onCodeClick:t,selectedTopicId:n,output:l,isRunning:f,plotImages:o})=>{const y=m.useRef(null),b=m.useMemo(()=>{var k,c;if(!s)return null;const i=(k=s.content)==null?void 0:k.intro;if(i){let a="";if(typeof i=="string")a=i;else if(typeof i=="object"){a=`# ${i.title||""}
...
`));const v=e||((c=s.content)==null?void 0:c.body)||i.body;if(v)if(a+=`
...
`);const d=[];a=a.replace(/\$\$([\s\S]*?)\$\$/g,(v,g)=>{const E=d.length;return d.push({type:"display",content:g}),` @@MATH_BLOCK_${E}@@ `}),a=a.replace(/\\begin\{aligned\}([\s\S]*?)\\end\{aligned\}/g,(v,g)=>{const E=d.length;return d.push({type:"display",content:`\\begin{aligned}${g}\\end{aligned}`}),` @@MATH_BLOCK_${E}@@ `}),a=a.replace(new RegExp("(?<!\\\\)\\$([^$\\n]+?)\\$","g"),(v,g)=>{const E=d.length;return d.push({type:"inline",content:g}),` @@MATH_BLOCK_${E}@@ `});let x=Re.parse(a).replace(/<h3>(.*?)<\/h3>/g,(v,g)=>`<h3 id="${"topic-"+g.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${g}</h3>`);const N=je.sanitize(x,{USE_PROFILES:{html:!0,mathml:!0},ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename","encoding","display"]}),$=[...s.examples||[]].sort((v,g)=>g.filename.length-v.filename.length);let R=N;return $.forEach(v=>{const g=v.filename.replace(".","\\."),E=new RegExp(`(?<!['".\\w])(${g})(?!['".\\w])`,"g");R=R.replace(E,`<span class="code-link" data-filename="${v.filename}">${v.filename}</span>`)}),R.replace(/@@MATH_BLOCK_(\d+)@@/g,(v,g)=>{const E=d[parseInt(g)];return E.type==="display"?`\\[ ${E.content.trim()} \\]`:`\\( ${E.content.trim()} \\)`})}else{const a=s.examples||[];let d=`
        <div class="chapter-intro">
          <h2>${s.title}</h2>
          <p>本章包含 ${a.length} 個程式範例</p>
          <div class="example-grid">
      `;return a.forEach((u,x)=>{d+=`
      ...
      `,d}},[s,e]);return m.useEffect(()=>{const i=k=>{if(k.target.classList.contains("code-link")){const c=k.target.dataset.filename;let a=null;s!=null&&s.examples&&(a=s.examples.find(d=>d.filename===c),a&&!a.metadata&&(a.metadata={description:a.title})),a&&t(a)}};return document.addEventListener("click",i),()=>document.removeEventListener("click",i)},[s,t]),m.useEffect(()=>{const i=document.querySelector(".content-scroll");i&&(i.scrollTop=0)},[s]),m.useEffect(()=>{y.current&&b&&Fe(y.current,{delimiters:[{left:"$$",right:"$$",display:!0},{left:"$",right:"$",display:!1},{left:"\\(",right:"\\)",display:!1},{left:"\\[",right:"\\]",display:!0}],throwOnError:!1,strict:"ignore"})},[b]),m.useEffect(()=>{if(n){const i=document.getElementById(n);i&&i.scrollIntoView({behavior:"smooth",block:"start"})}},[n]),m.useEffect(()=>{if(l||o&&o.length>0||f){const i=document.querySelector(".content-scroll");i&&i.scrollTo({top:0,behavior:"instant"})}},[l,o,f]),r.jsx("div",{className:"content-panel",children:r.jsx("div",{className:"content-scroll",children:l||o&&o.length>0||f?r.jsxs("div",{id:"execution-output",className:"execution-output-section",children:[f&&r.jsxs("div",{className:"running-indicator",children:[r.jsx("div",{className:"spinner"}),r.jsx("span",{children:"程式執行中..."})]}),l&&r.jsx("pre",{className:"output-text",children:l}),o&&o.length>0&&r.jsx("div",{className:"output-images",children:o.map((i,k)=>r.jsx("div",{className:"output-image",children:r.jsx("img",{src:i,alt:`Plot ${k+1}`})},k))})]}):b?r.jsx("div",{ref:y,className:"markdown-body",dangerouslySetInnerHTML:{__html:b}}):r.jsx("div",{className:"welcome-screen",children:r.jsxs("div",{className:"welcome-card premium-welcome",children:[r.jsxs("div",{className:"welcome-brand",children:[r.jsx("img",{src:"book-cover.jpg",alt:"FRM Python 理論與實戰",className:"welcome-book-img"}),r.jsx("a",{href:"https://deepwisdom.com.tw/product/%e6%89%8b%e8%a1%93%e5%88%80%e8%88%ac%e7%b2%be%e6%ba%96%e7%9a%84frm-%e7%94%a8python%e7%a7%91%e5%ad%b8%e7%ae%a1%e6%8e%a7%e8%b2%a1%e9%87%91%e9%a2%a8%e9%9a%aa%e5%9f%ba%e7%a4%8e%e7%af%87dm2301/",target:"_blank",rel:"noopener noreferrer",className:"welcome-purchase-btn",children:"[ 本書官網購買連結 ]"})]}),r.jsxs("div",{className:"welcome-content",children:[r.jsxs("h2",{className:"welcome-title",children:["手術刀般精準的 FRM 用 Python",r.jsx("br",{}),"科學管控財金風險：基礎篇"]}),r.jsx("div",{className:"welcome-slogan",children:"☆★☆★【有如手術刀般精準！利用Python幫你管控財金風險！】★☆★☆"}),r.jsxs("div",{className:"welcome-text-scroll",children:[r.jsx("p",{children:"本書使用了當紅的程式語言 Python，從程式設計的基本觀念談起。沒有 Python 基礎也沒關係，完整的 Python 介紹，讓您能順利銜接資料科學家最常用的套件整理，包括 Numpy，以及特別針對格式化表格類處理的 Pandas，也充分介紹了 Dataframe 的各種應用。"}),r.jsx("p",{children:"在有了充足的資料之後，接著需要有可以展示數據的工具。除了大家最愛用的 Matplotlib 之外，也介紹了高手才會用的 Seaborn。當熟悉了工具之後，就正式進入了金融理論，包括基礎的機率及統計、各種模型及機率分佈，以及抽樣、信賴區間等內容說明。"}),r.jsx("p",{children:"最後則進入到金融領域，除了介紹各種計算的演算法、模型、術語，也結合了前面所學的 Python 及工具，並講解金融商品最重要的「固定收益分析」。"}),r.jsx("p",{children:"本書從科學下手，讓您精準了解金融原理，確保金錢不再陷入水深火熱之中，將是您從科學到金融領域最重要的橋樑。"})]})]})]})})})})});function $e(){return null}function Me(s={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:n,onRegistered:l,onRegisteredSW:f,onRegisterError:o}=s;let y,b,i;const k=async(a=!0)=>{await b,i==null||i()};async function c(){if("serviceWorker"in navigator){if(y=await ce(async()=>{const{Workbox:a}=await import("./vendor-B3CQIlJd.js").then(d=>d.w);return{Workbox:a}},[]).then(({Workbox:a})=>new a("/pwa_FRM_Book1_python/sw.js",{scope:"/pwa_FRM_Book1_python/",type:"classic"})).catch(a=>{o==null||o(a)}),!y)return;i=()=>{y==null||y.messageSkipWaiting()};{let a=!1;const d=()=>{a=!0,y==null||y.addEventListener("controlling",u=>{u.isUpdate&&window.location.reload()}),t==null||t()};y.addEventListener("installed",u=>{typeof u.isUpdate>"u"?typeof u.isExternal<"u"&&u.isExternal?d():!a&&(n==null||n()):u.isUpdate||n==null||n()}),y.addEventListener("waiting",d)}y.register({immediate:e}).then(a=>{f?f("/pwa_FRM_Book1_python/sw.js",a):l==null||l(a)}).catch(a=>{o==null||o(a)})}}return b=c(),k}function Te(s={}){const{immediate:e=!0,onNeedRefresh:t,onOfflineReady:n,onRegistered:l,onRegisteredSW:f,onRegisterError:o}=s,[y,b]=m.useState(!1),[i,k]=m.useState(!1),[c]=m.useState(()=>Me({immediate:e,onOfflineReady(){k(!0),n==null||n()},onNeedRefresh(){b(!0),t==null||t()},onRegistered:l,onRegisteredSW:f,onRegisterError:o}));return{needRefresh:[y,b],offlineReady:[i,k],updateServiceWorker:c}}function De(){const{offlineReady:[s,e],needRefresh:[t,n],updateServiceWorker:l}=Te({onRegisteredSW(o,y){console.debug(`Service Worker at: ${o}`),y&&setInterval(()=>{y.update()},36e5)},onRegisterError(o){console.warn("SW registration error",o)}}),f=()=>{e(!1),n(!1)};return r.jsx("div",{className:"ReloadPrompt-container",children:(s||t)&&r.jsxs("div",{className:"ReloadPrompt-toast",children:[r.jsx("div",{className:"ReloadPrompt-message",children:s?"App ready to work offline":"New content available, click on reload button to update."}),t&&r.jsx("button",{className:"ReloadPrompt-toast-button",onClick:()=>l(!0),children:"Reload"}),r.jsx("button",{className:"ReloadPrompt-toast-button",onClick:f,children:"Close"})]})})}function Ie(s){const[e,t]=m.useState(null),[n,l]=m.useState(!1),f=m.useRef({});return m.useEffect(()=>{if(!s){t(null);return}const o=s.content,y=s.id;if(o!=null&&o.body&&!(o!=null&&o.bodyRef)){t(o.body);return}const b=o==null?void 0:o.bodyRef;if(!b||!Array.isArray(b)||b.length===0){t(null);return}let i=!1;return l(!0),(async()=>{const c={};await Promise.all(b.map(async a=>{const d=`${y}/${a}`;if(f.current[d]!==void 0){c[a]=f.current[d];return}try{const u=`/pwa_FRM_Book1_python/data/modular/${y}/${a}.json`,x=await fetch(u);if(!x.ok)throw new Error(`HTTP ${x.status}`);const F=(await x.json()).content||"";f.current[d]=F,c[a]=F}catch(u){console.warn(`[useBodyContent] Failed to load ${y}/${a}:`,u),c[a]=""}})),i||(t(c),l(!1))})(),()=>{i=!0}},[s]),{bodyContent:e,bodyLoading:n}}const pe=`
# QuantLib (ql) 強大模擬層
...
try:
    ...
    pass
`;let Y=null,T=null;const Ue=["https://cdn.jsdelivr.net/pyodide/v0.26.4/full/pyodide.js","https://unpkg.com/pyodide@0.26.4/pyodide.js"];function He(s){return new Promise((e,t)=>{const n=document.createElement("script");n.src=s,n.crossOrigin="anonymous",n.onload=e,n.onerror=()=>t(new Error(`Failed to load script: ${s}`)),document.head.appendChild(n)})}async function Ve(){if(typeof window.loadPyodide!="function"){console.warn("window.loadPyodide not found, loading dynamically...");for(const s of Ue)try{if(await He(s),typeof window.loadPyodide=="function"){console.log(`Pyodide loaded from ${s}`);return}}catch(e){console.warn(`Failed to load Pyodide from ${s}:`,e.message)}throw new Error("Failed to load Pyodide from all CDN sources")}}class Ge{constructor(e){this.onProgress=e,this.current=0,this.target=0,this.message="",this.interval=null,this.step=.1}start(){this.interval||(this.interval=setInterval(()=>{if(this.current<this.target){const e=this.target-this.current,t=e>20?3.5:e>5?1.5:.5;this.current=Math.min(this.current+t,this.target),this.onProgress(Math.floor(this.current),this.message)}else this.target<99&&(this.current=Math.min(this.current+.08,99.9),this.onProgress(Math.floor(this.current),this.message))},100))}update(e,t){this.target=e,t&&(this.message=t)}async yieldToUI(){return new Promise(e=>setTimeout(e,30))}finish(e="Ready!"){this.interval&&clearInterval(this.interval),this.current=100,this.onProgress(100,e)}}async function Ye(s){return Y?(s&&s(100,"Ready"),Y):T?T.then(e=>(s&&s(100,"Ready"),e)):(T=(async()=>{const e=new Ge(s);e.start();try{e.update(10,"正在啟動 Python 直譯器 (v0.26.4)..."),await Ve();let t=null,n=3;for(;n>0;)try{const c="https://cdn.jsdelivr.net/pyodide/v0.26.4/full/";console.log("Using Pyodide CDN for packages:",c),t=await window.loadPyodide({indexURL:c});break}catch(c){if(console.warn(`Failed to load Pyodide (attempts left: ${n-1}):`,c),n--,n===0)throw c;await new Promise(a=>setTimeout(a,1e3))}try{const c=document.getElementById("inline-scipy-stub");if(c&&c.textContent&&c.textContent.trim().length>0)try{await t.runPythonAsync(c.textContent),console.log("Inline SciPy stub executed early.")}catch(a){console.debug("Inline SciPy stub skipped:",a)}}catch(c){console.debug("Error checking inline SciPy stub:",c)}e.update(25,"引擎啟動完成，正在檢查本地暫存環境..."),await e.yieldToUI();const l="/lib/python3.12/site-packages";try{t.FS.mkdirTree(l)}catch{}t.FS.mount(t.FS.filesystems.IDBFS,{},l),e.update(26,"正在從本地儲存區載入 Python 環境..."),await new Promise(c=>{t.FS.syncfs(!0,a=>{a&&console.error("IDBFS sync error:",a),c()})}),await e.yieldToUI();const f=["numpy","pandas","matplotlib","sympy","lxml","micropip"],o=["numpy-financial","pandas-datareader","pyodide-http","pymoo==0.4.1","seaborn"],y=t.FS.readdir(l),b=f.filter(c=>!y.includes(c)&&!y.some(a=>a.startsWith(c+"-"))),i=o.filter(c=>{const a=c.replace("-","_");return!y.includes(c)&&!y.includes(a)&&!y.some(d=>d.startsWith(c+"-"))&&!y.some(d=>d.startsWith(a+"-"))});if(b.length>0||i.length>0){const c=[...b,...i];if(e.update(30,`正在同步並安裝套件: ${c.join(", ")}...`),b.length>0&&(e.update(40,`正在從 CDN 獲取核心科學套件 (${b.length} 個)...`),await t.loadPackage(b)),i.length>0){e.update(70,`正在掛載第三方擴充資源 (${i.length} 個)...`),await t.loadPackage("micropip");const a=t.pyimport("micropip"),d=i.map(u=>u==="numpy-financial"?"/pwa_FRM_Book1_python/wheels/numpy_financial-1.0.0-py3-none-any.whl":u);await a.install(d)}e.update(85,"正在固化環境映射至本地磁碟..."),await new Promise(a=>{t.FS.syncfs(!1,d=>{d&&console.error("IDBFS save error:",d),a()})}),e.update(90,"✅ 環境已完成本地持久化儲存")}else e.update(90,"🚀 偵測到本地環境快照，已跳過網路請求");return await e.yieldToUI(),e.update(92,"⚙️ 配置：正在載入環境優化補丁..."),await e.yieldToUI(),await Promise.all([t.runPythonAsync(`
import warnings
warnings.simplefilter("ignore", DeprecationWarning)
warnings.simplefilter("ignore", FutureWarning)
warnings.simplefilter("ignore", SyntaxWarning)
...
try:
    ...
    for func in ['irr', 'npv', 'pmt', 'pv', 'rate', 'nper', 'fv', 'ppmt', 'ipmt']:
        if not hasattr(np, func) and hasattr(npf, func): setattr(np, func, getattr(npf, func))
                ...
                `)]),await e.yieldToUI(),e.update(95,"🔬 系統：正在安裝 SciPy 純 Python 計算引擎..."),await e.yieldToUI(),await t.runPythonAsync(Qe),e.update(98,"🚀 系統：正在啟動 Pymoo & QuantLib 虛擬層..."),await e.yieldToUI(),await Promise.all([t.runPythonAsync(We),t.runPythonAsync(Be),t.runPythonAsync(pe),t.runPythonAsync(me),t.runPythonAsync(Oe)]),e.update(99,"🛡️ 系統：權限校正與輸入掛鉤注入..."),await t.runPythonAsync(`
import builtins
import js
def custom_input(prompt = ""):
    try:
...
builtins.input = custom_input
            `),await e.yieldToUI(),Y=t,T=null,e.finish("載入完成！正在進入主介面..."),t}catch(t){throw T=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),T)}async function Ke(s,e,t=3e4){let n;const l=new Promise((f,o)=>{n=setTimeout(()=>{o(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([s.runPythonAsync(e),l])}finally{clearTimeout(n)}}async function Je(s){if(s)try{await s.runPythonAsync(`
            import gc
import matplotlib.pyplot as plt
            plt.close('all')
            gc.collect()
                `)}catch{}}const re=new Set;async function le(s,e){!s||!e||re.has(e)||re.add(e)}async function Ze(s){if(s)try{await s.loadPackage("micropip");const e=s.pyimport("micropip"),t=["/pwa_FRM_Book1_python/wheels/pymoo-0.4.1-py3-none-any.whl","/pwa_FRM_Book1_python/wheels/pandas_datareader-0.10.0-py3-none-any.whl","/pwa_FRM_Book1_python/wheels/pyodide_http-0.2.2-py3-none-any.whl","/pwa_FRM_Book1_python/wheels/seaborn-0.13.2-py3-none-any.whl"];await e.install(t,{transient:!0}).catch(n=>{console.warn("preloadHeavyPackages pip install failed",n)})}catch(e){console.warn("preloadHeavyPackages error",e)}}async function Xe(s){try{const e=await s.runPythonAsync(`
import matplotlib.pyplot as plt
len(plt.get_fignums())
...
base64.b64encode(buf.read()).decode('utf-8')
      `);t.push(`data:image/png;base64,${l}`)}catch(l){console.warn(`Skipping figure ${n+1} due to capture error`,l)}return await s.runPythonAsync('import matplotlib.pyplot as plt; plt.close("all")'),t}catch(e){return console.error("Failed to capture plots:",e),[]}}async function ie(s,e=!1){try{const t=e?"module://matplotlib_pyodide.wasm_backend":"AGG";await s.runPythonAsync(`
import matplotlib
import matplotlib.pyplot as plt
import warnings
matplotlib.use('${t}')
...
if len(plt.get_fignums()) > 0:
    plt.show()
    `)}catch(e){console.error("Failed to show plots:",e)}}function oe(s){const e=s.message||String(s),t=[{pattern:/NameError: name '(.+)' is not defined/,format:n=>`❌ 變數錯誤：'${n[1]}' 未定義
...
• 確認模組名稱正確
• 檢查是否支援該模組
• 查看完整錯誤訊息了解詳情`}];for(const{pattern:n,format:l}of t){const f=e.match(n);if(f)return l(f)}return`❌ 執行錯誤
...
• 逐行執行程式碼找出問題
• 使用 print() 輸出變數值
• 簡化程式碼，逐步測試`}class tt{constructor(){this.metrics={},this.enabled=!0}start(e){this.enabled&&(this.metrics[e]={start:performance.now(),end:null,duration:null})}end(e){if(!this.enabled||!this.metrics[e])return 0;const t=performance.now(),n=this.metrics[e].start,l=t-n;return this.metrics[e].end=t,this.metrics[e].duration=l,this.log(e,l),l}log(e,t){const n=t<100?"⚡":t<1e3?"⏱️":"🐌",l=t<100?"color: green":t<1e3?"color: orange":"color: red";console.log(`%c${n} ${e}: ${t.toFixed(2)}ms`,l),t>1e3&&console.warn(`⚠️ ${e} 執行時間過長: ${t.toFixed(2)}ms`)}async measure(e,t){this.start(e);try{return await t()}finally{this.end(e)}}getMetric(e){return this.metrics[e]||null}getMetrics(){return{...this.metrics}}getStats(){const e=Object.values(this.metrics).filter(t=>t.duration!==null).map(t=>t.duration);return e.length===0?{count:0,total:0,average:0,min:0,max:0}:{count:e.length,total:e.reduce((t,n)=>t+n,0),average:e.reduce((t,n)=>t+n,0)/e.length,min:Math.min(...e),max:Math.max(...e)}}clear(e){e?delete this.metrics[e]:this.metrics={}}setEnabled(e){this.enabled=e}report(){const e=this.getStats();console.group("📊 效能報告"),console.log(`總計測量: ${e.count} 次`),console.log(`總時間: ${e.total.toFixed(2)}ms`),console.log(`平均時間: ${e.average.toFixed(2)}ms`),console.log(`最快: ${e.min.toFixed(2)}ms`),console.log(`最慢: ${e.max.toFixed(2)}ms`),console.groupEnd(),console.group("📋 詳細指標"),Object.entries(this.metrics).forEach(([t,n])=>{n.duration!==null&&console.log(`${t}: ${n.duration.toFixed(2)}ms`)}),console.groupEnd()}}const B=new tt;B.setEnabled(!1);let fe=!1;function at(){if(!fe&&(fe=!0,"PerformanceObserver"in window)){new PerformanceObserver(l=>{const f=l.getEntries(),o=f[f.length-1];console.log("🎨 LCP:",o.renderTime||o.loadTime)}).observe({entryTypes:["largest-contentful-paint"]}),new PerformanceObserver(l=>{l.getEntries().forEach(o=>{console.log("⚡ FID:",o.processingStart-o.startTime)})}).observe({entryTypes:["first-input"]});let t=0;new PerformanceObserver(l=>{l.getEntries().forEach(o=>{o.hadRecentInput||(t+=o.value)}),console.log("📐 CLS:",t)}).observe({entryTypes:["layout-shift"]})}}const st=m.lazy(()=>ce(()=>import("./CodePreviewPanel-DcyHY-xF.js"),__vite__mapDeps([0,1,2,3]))),K={QuantLib:"QuantLib",arch:"arch",autograd:"autograd",chart_studio:"chart-studio",datetime:"datetime",lxml:"lxml",math:"math",matplotlib:"matplotlib",mcint:"mcint",mibian:"mibian",mpl_toolkits:"matplotlib",numpy:"numpy",numpy_financial:"wheels/numpy_financial-1.0.0-py3-none-any.whl",openpyxl:"openpyxl",pandas:"pandas",pandas_datareader:"wheels/pandas_datareader-0.10.0-py3-none-any.whl",plotly:"plotly",prettytable:"prettytable",pylab:"matplotlib",pymoo:"wheels/pymoo-0.4.1-py3-none-any.whl",pyodide_http:"wheels/pyodide_http-0.2.2-py3-none-any.whl",qpsolvers:"qpsolvers",requests:"requests","scikit-learn":"scikit-learn",scipy:"scipy",seaborn:"wheels/seaborn-0.13.2-py3-none-any.whl",sklearn:"scikit-learn",statsmodels:"statsmodels",sympy:"sympy",tabulate:"tabulate"},de={requests:["certifi","charset_normalizer","idna","urllib3"],certifi:"wheels/certifi-2026.1.4-py3-none-any.whl",charset_normalizer:"wheels/charset_normalizer-3.4.4-py3-none-any.whl",idna:"wheels/idna-3.11-py3-none-any.whl",urllib3:"wheels/urllib3-2.6.3-py3-none-any.whl"};typeof window<"u"&&"serviceWorker"in navigator&&(async()=>{try{const s=`/pwa_FRM_Book1_python/manifest.webmanifest?t=${Date.now()}`;let e=null;try{const f=await fetch(s,{cache:"no-store"});f&&f.ok&&(e=await f.text())}catch{}if(!e)return;const t=localStorage.getItem("app_assets_manifest_text");if(t&&t===e)return;localStorage.setItem("app_assets_manifest_text",e);const n=await navigator.serviceWorker.getRegistrations();if(!n||n.length===0){localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),location.reload());return}for(const f of n)try{await f.update(),f.waiting&&f.waiting.postMessage({type:"SKIP_WAITING"})}catch(o){console.warn("SW update attempt failed:",o)}const l=()=>{localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),window.location.reload())};navigator.serviceWorker.addEventListener("controllerchange",l)}catch(s){console.warn("Version check/update failed:",s)}})();function nt(){const[s,e]=m.useState(null),[t,n]=m.useState(!0),[l,f]=m.useState(0),[o,y]=m.useState("初始化中..."),[b,i]=m.useState([]),[k,c]=m.useState(!0),[a,d]=m.useState(null),[u,x]=m.useState(null),[N,F]=m.useState(""),[$,R]=m.useState({}),{bodyContent:D}=Ie(a),[v,g]=m.useState(""),[E,C]=m.useState([]),[W,U]=m.useState(!1),[J,ue]=m.useState(!1),[A,_e]=m.useState(()=>{const _=localStorage.getItem("theme");return _==="dark"||!_&&!1}),[Z,ge]=m.useState(600),[M]=m.useState(new Set),[X,ee]=m.useState(null),te=m.useRef(!1);m.useEffect(()=>{c(!0);const _=`/pwa_FRM_Book1_python/data/chapters_index.json?t=${Date.now()}`;fetch(_).then(p=>p.json()).then(p=>{p&&p.length>0&&i(p),c(!1)}).catch(p=>{console.error("Failed to load chapters index:",p),c(!1)})},[]);const ye=async _=>{if($[_])return $[_];try{c(!0);const p=await fetch(`/pwa_FRM_Book1_python/data/chapters_${_}.json?t=${Date.now()}`);if(!p.ok)throw new Error(`HTTP error! status: ${p.status}`);const q=await p.text();let z=null;try{z=JSON.parse(q)}catch{try{const P=q.replace(/\\(?!["\\/bfnrtu])/g,"\\\\");z=JSON.parse(P)}catch(P){throw new Error(`Failed to parse chapter data: ${P.message}`)}}return R(P=>({...P,[_]:z})),c(!1),z}catch(p){return console.error(`Failed to load chapter ${_}:`,p),c(!1),null}};m.useEffect(()=>{Ye((p,q)=>{f(p),y(q)}).then(p=>{e(p),n(!1),B.end("pyodide-init")}),at();const _=[];if("serviceWorker"in navigator){const p=setInterval(()=>{navigator.serviceWorker.getRegistrations().then(z=>{z.forEach(P=>P.update())})},36e5),q=()=>{};navigator.serviceWorker.addEventListener("controllerchange",q),_.push(()=>{clearInterval(p),navigator.serviceWorker.removeEventListener("controllerchange",q)})}if("storage"in navigator&&"estimate"in navigator.storage){const p=async()=>{try{const z=await navigator.storage.estimate();z.usage&&z.quota&&z.usage/z.quota*100>80&&console.warn("Storage usage is high (>80%). Consider cleaning up.")}catch(z){console.warn("Failed to check storage quota:",z)}};p();const q=setInterval(p,300*1e3);_.push(()=>clearInterval(q))}return()=>{_.forEach(p=>p())}},[]),m.useEffect(()=>{s&&!t&&Ze(s).then(()=>{te.current||(te.current=!0,console.warn("Background initialization complete"))}).catch(_=>console.error("Background loaded failed",_))},[s,t]),m.useEffect(()=>{localStorage.setItem("theme",A?"dark":"light"),document.documentElement.setAttribute("data-theme",A?"dark":"light")},[A]);const ae=async(_,p=!1)=>{var ne;if(!s)return;const q=_.match(/^\s*(?:from|import)\s+([a-zA-Z0-9_]+)/gm);if(!q)return;if(/^\s*(?:from|import)\s+QuantLib\b/m.test(_)&&!M.has("QuantLib"))try{p||g(h=>h+`正在啟用 QuantLib 相容性墊片...
`),await s.runPythonAsync(pe),M.add("QuantLib"),p||g(h=>h+`✅ QuantLib 墊片已啟用。
`)}catch(h){console.warn("QuantLib shim injection failed:",h),p||g(w=>w+`⚠️ QuantLib 墊片啟用失敗，將嘗試繼續執行...
`)}const z=["sys","os","io","time","timeit","base64","json","datetime","math","re","warnings","builtins","types","random","csv","copy","collections","itertools","functools","pathlib","fractions","struct","operator","string","decimal","abc","enum","typing","textwrap"],P=["numpy","pandas","matplotlib","micropip","js","builtins","QuantLib","mcint","arch","mibian"],j=[...new Set(q.map(h=>{const w=h.trim().split(/\s+/);return w[0]==="from",w[1].split(".")[0]}))].filter(h=>!z.includes(h)&&!P.includes(h)).filter(h=>{var w;return!M.has(h)&&!((w=window.failedPackages)!=null&&w.has(h))});if(j.length===0)return;const I=[],O=[],H=new URL("/pwa_FRM_Book1_python/",window.location.origin).href,qe=new Set(["scipy","statsmodels","scikit-learn","sympy"]),Q=h=>{if(h){if(typeof h=="string"&&(h.endsWith(".whl")||h.startsWith("http"))){O.push(h);return}qe.has(h)?I.push(h):O.push(h)}},se={sklearn:["scipy","scikit-learn"],"scikit-learn":["scipy"],statsmodels:["scipy"],sympy:[],seaborn:["matplotlib","pandas","scipy","statsmodels"],pandas_datareader:["requests"]};if(j.forEach(h=>{const w=K[h];w?(Q(w.endsWith(".whl")?H+w:w),(de[h]||[]).forEach(L=>{const V=de[L]||L;Q(V.endsWith(".whl")?H+V:V)})):Q(h),se[h]&&se[h].forEach(S=>{if(!M.has(S)&&!P.includes(S)){const L=K[S]||S;Q(L.endsWith(".whl")?H+L:L)}})}),I.length>0||O.length>0)try{const h=[...new Set(I)],w=[...new Set(O)];p||g(S=>S+`正在動態載入所需套件 [${j.join(", ")}]...
`);for(const S of h)await s.loadPackage(S);w.length>0&&(await s.loadPackage("micropip"),await s.runPythonAsync(`
import micropip
await micropip.install(${JSON.stringify(w)}, keep_going=True)
          `)),j.includes("pandas_datareader")&&await s.runPythonAsync(me),j.includes("matplotlib")&&(await ie(s),X||ee("AGG")),j.forEach(S=>{M.add(S);const L=K[S];L&&!L.endsWith(".whl")&&M.add(L)}),p||g(S=>S+`✅ 套件載入完成。
`)}catch(h){if(console.warn("Dependency loading failed:",h),window.failedPackages||(window.failedPackages=new Set),j.forEach(w=>window.failedPackages.add(w)),!p){const w=h.message||String(h);if(w.includes("Can't find a pure Python 3 wheel")){const S=((ne=w.match(/for: '([^']+)'/))==null?void 0:ne[1])||"unknown";g(L=>L+`⚠️ 套件 "${S}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else g(S=>S+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},he=async _=>{if(!(!s||W||!_)){U(!0),g(`執行中...
`),C([]);try{a&&a.id&&await le(s,a.id),await ae(_),B.start("run-code"),await Je(s);const p=_.includes("matplotlib.widgets")||_.includes("Slider")||_.includes("Button");ue(p);const q=p?"module://matplotlib_pyodide.wasm_backend":"AGG";if(X!==q&&(await ie(s,p),ee(q)),await s.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),p){const P=document.getElementById("pyodide-plot-container");P&&(P.innerHTML="",window.document.pyodideMplTarget=P)}try{await Ke(s,_)}catch(P){const j=await s.runPythonAsync("sys.stdout.getvalue()"),I=oe(P);g((j?j+`
`:"")+I),U(!1),B.end("run-code");return}const z=await s.runPythonAsync("sys.stdout.getvalue()");if(g(z||"執行完成（無文字內容輸出 ）"),J)await et(s);else{const P=await Xe(s);C(P)}}catch(p){const q=oe(p);g(q),console.error(p)}finally{U(!1),B.end("run-code")}}},xe=async _=>{let p=_;if(_&&!_.content&&(p=await ye(_.id)),!!p&&(d(p),x(null),F(""),g(""),C([]),p&&p.examples&&s)){const q=p.examples.map(z=>z.code).join(`
`);ae(q,!0)}};m.useEffect(()=>{s&&a&&a.id&&le(s,a.id).catch(_=>console.error("Dataset lazy load failed",_))},[s,a]);const be=_=>{x(_),g(""),C([])},ve=_=>{x(_),g(""),C([])},we=()=>{x(null),g(""),C([])},ke=t;return r.jsxs("div",{className:`app ${A?"dark":""}`,children:[r.jsxs("div",{className:"main-content",children:[r.jsxs("div",{className:"top-bar",children:[r.jsxs("div",{className:"top-bar-left",children:[r.jsx(ze,{size:20,className:"logo-icon"}),r.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),r.jsx(Ae,{chapters:b,currentChapter:a,bodyContent:D,onChapterSelect:xe,currentScript:u,onScriptSelect:ve,selectedTopicId:N,onTopicSelect:F,loading:k}),r.jsx("div",{className:"top-bar-right",children:r.jsx("button",{className:"theme-toggle",onClick:()=>_e(!A),title:A?"切換到亮色模式":"切換到暗色模式",children:A?r.jsx(Pe,{size:20}):r.jsx(Se,{size:20})})})]}),ke&&r.jsx("div",{className:"hydration-overlay",children:r.jsxs("div",{className:"hydration-card",children:[r.jsxs("div",{className:"hydration-header",children:[r.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),r.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),r.jsx("div",{className:"hydration-progress-container",children:r.jsx("div",{className:"hydration-progress-bar",style:{width:`${l}%`}})}),r.jsxs("div",{className:"hydration-status",children:[r.jsx("span",{children:o}),r.jsxs("span",{children:[l,"%"]})]})]})}),r.jsxs("div",{className:"panes-container",children:[r.jsx("div",{className:"content-pane",children:r.jsx(Ce,{chapter:a,bodyContent:D,onCodeClick:be,selectedTopicId:N,darkMode:A,output:v,isRunning:W,plotImages:E,onClearOutput:()=>{g(""),C([])}})}),u&&r.jsx("div",{className:"preview-pane",style:{width:`${Z}px`},children:r.jsx(m.Suspense,{fallback:r.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:r.jsx(st,{script:u,onClose:we,onRun:he,isRunning:W,isLoading:t,output:v,images:E,isInteractive:J,darkMode:A,width:Z,onResize:ge})})})]})]}),r.jsx($e,{pyodide:s}),r.jsx(De,{})]})}async function rt(){try{if(!("serviceWorker"in navigator))return;const s="frm_sw_cleanup_done_v1";if(localStorage.getItem(s))return;if(!navigator.serviceWorker.controller){localStorage.setItem(s,"1");return}console.info("[AUTO-CLEAN] Detected active Service Worker — cleaning caches and storage.");try{const e=await navigator.serviceWorker.getRegistrations();await Promise.all(e.map(t=>t.unregister().catch(()=>{}))),console.info("[AUTO-CLEAN] serviceWorker registrations unregistered.")}catch(e){console.warn("[AUTO-CLEAN] Failed to unregister service workers",e)}try{if("caches"in window){const e=await caches.keys();await Promise.all(e.map(t=>caches.delete(t).catch(()=>{}))),console.info("[AUTO-CLEAN] CacheStorage cleared:",e)}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear CacheStorage",e)}try{if("databases"in indexedDB){const e=await indexedDB.databases();await Promise.all(e.map(t=>indexedDB.deleteDatabase(t.name).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB databases deleted:",e.map(t=>t.name))}else{const e=["pyodide","emscripten-archives","idb-filesystem","file_storage"];await Promise.all(e.map(t=>indexedDB.deleteDatabase(t).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB fallback delete attempted for candidates.")}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear IndexedDB",e)}try{localStorage.clear(),sessionStorage.clear(),console.info("[AUTO-CLEAN] localStorage and sessionStorage cleared.")}catch(e){console.warn("[AUTO-CLEAN] Failed to clear storage",e)}try{localStorage.setItem(s,"1")}catch{}try{console.info("[AUTO-CLEAN] Reloading page to load fresh assets."),window.location.reload(!0)}catch(e){console.info("[AUTO-CLEAN] Reload skipped.",e)}}catch(s){console.warn("[AUTO-CLEAN] Unexpected error",s)}}rt().catch(()=>{});Ee.createRoot(document.getElementById("root")).render(r.jsx(Le.StrictMode,{children:r.jsx(nt,{})}));
