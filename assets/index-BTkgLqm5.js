...
import{r as f,j as r,C as V,_ as pe,B as Se,S as Ee,M as Ne,R as je,a as Le}from"./vendor-react-DBlZ22TX.js";import{B as Ae,p as Re}from"./vendor-utils-DahDrsZr.js";import{r as $e}from"./vendor-katex-CrEV6Ds-.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const c of o)if(c.type==="childList")for(const l of c.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const c={};return o.integrity&&(c.integrity=o.integrity),o.referrerPolicy&&(c.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?c.credentials="include":o.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(o){if(o.ep)return;o.ep=!0;const c=t(o);fetch(o.href,c)}})();function Me({chapters:s,currentChapter:e,bodyContent:t,onChapterSelect:n,currentScript:o,onScriptSelect:c,selectedTopicId:l,onTopicSelect:h,loading:b}){var k,p;const i=f.useMemo(()=>{const a=e==null?void 0:e.content;if(!a)return[];let d="";const u=a.intro;typeof u=="string"?d=u:u&&typeof u=="object"&&u.body&&(d+=typeof u.body=="string"?u.body:Object.values(u.body).join(`
`));const w=t||a.body;if(w&&(typeof w=="string"?d+=`
`+w:Array.isArray(w)?d+=`
`+w.join(`
`):typeof w=="object"&&(d+=`
`+Object.values(w).join(`
`))),!d)return[];const A=/^###\s+(.+)$/gm,$=[];let T;for(;(T=A.exec(d))!==null;){const D=T[1].trim(),I="topic-"+D.replace(/\s+/g,"-").toLowerCase();$.push({id:I,title:D})}return $},[e,t]);return r.jsxs("div",{className:"top-nav-container",children:[r.jsx("div",{className:"nav-group",children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:a=>{const d=s.find(u=>u.id===a.target.value);d&&n(d)},disabled:b||s.length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:b?"載入中...":"📖 章節選擇"}),s.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(V,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${!e||i.length===0?"disabled":""}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"topic-select",name:"topic-select",value:l,onChange:a=>h(a.target.value),disabled:!e||i.length===0,className:"custom-select",children:[r.jsx("option",{value:"",children:"💡 重點導覽"}),i.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(V,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"script-select",name:"script-select",value:(o==null?void 0:o.filename)||"",onChange:a=>{var u;const d=(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples);if(d){const w=d.find(A=>A.filename===a.target.value);w&&c(w)}},disabled:!e||!(e.examples||(k=e.content)!=null&&k.examples)||(e.examples||((p=e.content)==null?void 0:p.examples)||[]).length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var u;return[...(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples)||[]].sort((w,A)=>w.filename.localeCompare(A.filename,void 0,{numeric:!0,sensitivity:"base"})).map(w=>r.jsx("option",{value:w.filename,children:w.filename},w.filename))})()]}),r.jsx(V,{className:"select-icon",size:16})]})})]})}const De=new Ae,qe=f.memo(({chapter:s,bodyContent:e,onCodeClick:t,selectedTopicId:n,output:o,isRunning:c,plotImages:l})=>{const h=f.useRef(null),b=f.useMemo(()=>{var k,p;if(!s)return null;const i=(k=s.content)==null?void 0:k.intro;if(i){let a="";if(typeof i=="string")a=i;else if(typeof i=="object"){a=`# ${i.title||""}
...
`);const d=[];a=a.replace(/\$\$([\s\S]*?)\$\$/g,(v,y)=>{const j=d.length;return d.push({type:"display",content:y}),` @@MATH_BLOCK_${j}@@ `}),a=a.replace(/\\begin\{aligned\}([\s\S]*?)\\end\{aligned\}/g,(v,y)=>{const j=d.length;return d.push({type:"display",content:`\\begin{aligned}${y}\\end{aligned}`}),` @@MATH_BLOCK_${j}@@ `}),a=a.replace(new RegExp("(?<!\\\\)\\$([^$\\n]+?)\\$","g"),(v,y)=>{const j=d.length;return d.push({type:"inline",content:y}),` @@MATH_BLOCK_${j}@@ `});let w=De.parse(a).replace(/<h3>(.*?)<\/h3>/g,(v,y)=>`<h3 id="${"topic-"+y.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${y}</h3>`);const A=Re.sanitize(w,{USE_PROFILES:{html:!0,mathml:!0},ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename","encoding","display"]}),T=[...s.examples||[]].sort((v,y)=>y.filename.length-v.filename.length);let D=A;return T.forEach(v=>{const y=v.filename.replace(".","\\."),j=new RegExp(`(?<!['".\\w])(${y})(?!['".\\w])`,"g");D=D.replace(j,`<span class="code-link" data-filename="${v.filename}">${v.filename}</span>`)}),D.replace(/@@MATH_BLOCK_(\d+)@@/g,(v,y)=>{const j=d[parseInt(y)];return j.type==="display"?`\\[ ${j.content.trim()} \\]`:`\\( ${j.content.trim()} \\)`})}else{const a=s.examples||[];let d=`
      ...
      `,d}},[s,e]);return f.useEffect(()=>{const i=k=>{if(k.target.classList.contains("code-link")){const p=k.target.dataset.filename;let a=null;s!=null&&s.examples&&(a=s.examples.find(d=>d.filename===p),a&&!a.metadata&&(a.metadata={description:a.title})),a&&t(a)}};return document.addEventListener("click",i),()=>document.removeEventListener("click",i)},[s,t]),f.useEffect(()=>{const i=document.querySelector(".content-scroll");i&&(i.scrollTop=0)},[s]),f.useEffect(()=>{h.current&&b&&$e(h.current,{delimiters:[{left:"$$",right:"$$",display:!0},{left:"$",right:"$",display:!1},{left:"\\(",right:"\\)",display:!1},{left:"\\[",right:"\\]",display:!0}],throwOnError:!1,strict:"ignore"})},[b]),f.useEffect(()=>{if(n){const i=document.getElementById(n);i&&i.scrollIntoView({behavior:"smooth",block:"start"})}},[n]),f.useEffect(()=>{if(o||l&&l.length>0||c){const i=document.querySelector(".content-scroll");i&&i.scrollTo({top:0,behavior:"instant"})}},[o,l,c]),r.jsx("div",{className:"content-panel",children:r.jsx("div",{className:"content-scroll",children:o||l&&l.length>0||c?r.jsxs("div",{id:"execution-output",className:"execution-output-section",children:[c&&r.jsxs("div",{className:"running-indicator",children:[r.jsx("div",{className:"spinner"}),r.jsx("span",{children:"程式執行中..."})]}),o&&r.jsx("pre",{className:"output-text",children:o}),l&&l.length>0&&r.jsx("div",{className:"output-images",children:l.map((i,k)=>r.jsx("div",{className:"output-image",children:r.jsx("img",{src:i,alt:`Plot ${k+1}`})},k))})]}):b?r.jsx("div",{ref:h,className:"markdown-body",dangerouslySetInnerHTML:{__html:b}}):r.jsx("div",{className:"welcome-screen",children:r.jsxs("div",{className:"welcome-card premium-welcome",children:[r.jsxs("div",{className:"welcome-brand",children:[r.jsx("img",{src:"book-cover.jpg",alt:"FRM Python 理論與實戰",className:"welcome-book-img"}),r.jsx("a",{href:"https://deepwisdom.com.tw/product/%e6%89%8b%e8%a1%93%e5%88%80%e8%88%ac%e7%b2%be%e6%ba%96%e7%9a%84frm-%e7%94%a8python%e7%a7%91%e5%ad%b8%e7%ae%a1%e6%8e%a7%e8%b2%a1%e9%87%91%e9%a2%a8%e9%9a%aa%e5%9f%ba%e7%a4%8e%e7%af%87dm2301/",target:"_blank",rel:"noopener noreferrer",className:"welcome-purchase-btn",children:"[ 本書官網購買連結 ]"})]}),r.jsxs("div",{className:"welcome-content",children:[r.jsxs("h2",{className:"welcome-title",children:["手術刀般精準的 FRM 用 Python",r.jsx("br",{}),"科學管控財金風險：基礎篇"]}),r.jsx("div",{className:"welcome-slogan",children:"☆★☆★【有如手術刀般精準！利用Python幫你管控財金風險！】★☆★☆"}),r.jsxs("div",{className:"welcome-text-scroll",children:[r.jsx("p",{children:"本書使用了當紅的程式語言 Python，從程式設計的基本觀念談起。沒有 Python 基礎也沒關係，完整的 Python 介紹，讓您能順利銜接資料科學家最常用的套件整理，包括 Numpy，以及特別針對格式化表格類處理的 Pandas，也充分介紹了 Dataframe 的各種應用。"}),r.jsx("p",{children:"在有了充足的資料之後，接著需要有可以展示數據的工具。除了大家最愛用的 Matplotlib 之外，也介紹了高手才會用的 Seaborn。當熟悉了工具之後，就正式進入了金融理論，包括基礎的機率及統計、各種模型及機率分佈，以及抽樣、信賴區間等內容說明。"}),r.jsx("p",{children:"最後則進入到金融領域，除了介紹各種計算的演算法、模型、術語，也結合了前面所學的 Python 及工具，並講解金融商品最重要的「固定收益分析」。"}),r.jsx("p",{children:"本書從科學下手，讓您精準了解金融原理，確保金錢不再陷入水深火熱之中，將是您從科學到金融領域最重要的橋樑。"})]})]})]})})})})});function Te(){return null}function Ce(s={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:n,onRegistered:o,onRegisteredSW:c,onRegisterError:l}=s;let h,b,i;const k=async(a=!0)=>{await b,i==null||i()};async function p(){if("serviceWorker"in navigator){if(h=await pe(async()=>{const{Workbox:a}=await import("./vendor-B3CQIlJd.js").then(d=>d.w);return{Workbox:a}},[]).then(({Workbox:a})=>new a("/pwa_FRM_Book1_python/sw.js",{scope:"/pwa_FRM_Book1_python/",type:"classic"})).catch(a=>{l==null||l(a)}),!h)return;i=()=>{h==null||h.messageSkipWaiting()};{let a=!1;const d=()=>{a=!0,h==null||h.addEventListener("controlling",u=>{u.isUpdate&&window.location.reload()}),t==null||t()};h.addEventListener("installed",u=>{typeof u.isUpdate>"u"?typeof u.isExternal<"u"&&u.isExternal?d():!a&&(n==null||n()):u.isUpdate||n==null||n()}),h.addEventListener("waiting",d)}h.register({immediate:e}).then(a=>{c?c("/pwa_FRM_Book1_python/sw.js",a):o==null||o(a)}).catch(a=>{l==null||l(a)})}}return b=p(),k}function Fe(s={}){const{immediate:e=!0,onNeedRefresh:t,onOfflineReady:n,onRegistered:o,onRegisteredSW:c,onRegisterError:l}=s,[h,b]=f.useState(!1),[i,k]=f.useState(!1),[p]=f.useState(()=>Ce({immediate:e,onOfflineReady(){k(!0),n==null||n()},onNeedRefresh(){b(!0),t==null||t()},onRegistered:o,onRegisteredSW:c,onRegisterError:l}));return{needRefresh:[h,b],offlineReady:[i,k],updateServiceWorker:p}}function Ie(){const{offlineReady:[s,e],needRefresh:[t,n],updateServiceWorker:o}=Fe({onRegisteredSW(l,h){console.debug(`Service Worker at: ${l}`),h&&setInterval(()=>{h.update()},36e5)},onRegisterError(l){console.warn("SW registration error",l)}}),c=()=>{e(!1),n(!1)};return r.jsx("div",{className:"ReloadPrompt-container",children:(s||t)&&r.jsxs("div",{className:"ReloadPrompt-toast",children:[r.jsx("div",{className:"ReloadPrompt-message",children:s?"App ready to work offline":"New content available, click on reload button to update."}),t&&r.jsx("button",{className:"ReloadPrompt-toast-button",onClick:()=>o(!0),children:"Reload"}),r.jsx("button",{className:"ReloadPrompt-toast-button",onClick:c,children:"Close"})]})})}function Be(s){const[e,t]=f.useState(null),[n,o]=f.useState(!1),c=f.useRef({});return f.useEffect(()=>{if(!s){t(null);return}const l=s.content,h=s.id;if(l!=null&&l.body&&!(l!=null&&l.bodyRef)){t(l.body);return}const b=l==null?void 0:l.bodyRef;if(!b||!Array.isArray(b)||b.length===0){t(null);return}let i=!1;return o(!0),(async()=>{const p={};await Promise.all(b.map(async a=>{const d=`${h}/${a}`;if(c.current[d]!==void 0){p[a]=c.current[d];return}try{const u=`/pwa_FRM_Book1_python/data/modular/${h}/${a}.json`,w=await fetch(u);if(!w.ok)throw new Error(`HTTP ${w.status}`);const $=(await w.json()).content||"";c.current[d]=$,p[a]=$}catch(u){console.warn(`[useBodyContent] Failed to load ${h}/${a}:`,u),p[a]=""}})),i||(t(p),o(!1))})(),()=>{i=!0}},[s]),{bodyContent:e,bodyLoading:n}}const me=`
# QuantLib (ql) 強大模擬層
