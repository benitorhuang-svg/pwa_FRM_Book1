...
import{r as u,j as r,C as Y,_ as me,B as Pe,S as Se,M as Ee,R as Ne,a as je}from"./vendor-react-CQh-Sngh.js";import{B as Le,p as Fe}from"./vendor-utils-DahDrsZr.js";import{r as Ae}from"./vendor-katex-CppR7rPA.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))n(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const o of c.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(l){if(l.ep)return;l.ep=!0;const c=t(l);fetch(l.href,c)}})();function Re({chapters:s,currentChapter:e,bodyContent:t,onChapterSelect:n,currentScript:l,onScriptSelect:c,selectedTopicId:o,onTopicSelect:y,loading:b}){var k,d;const i=u.useMemo(()=>{const a=e==null?void 0:e.content;if(!a)return[];let f="";const m=a.intro;typeof m=="string"?f=m:m&&typeof m=="object"&&m.body&&(f+=typeof m.body=="string"?m.body:Object.values(m.body).join(`
`));const x=t||a.body;if(x&&(typeof x=="string"?f+=`
`+x:Array.isArray(x)?f+=`
`+x.join(`
`):typeof x=="object"&&(f+=`
`+Object.values(x).join(`
`))),!f)return[];const j=/^###\s+(.+)$/gm,F=[];let T;for(;(T=j.exec(f))!==null;){const R=T[1].trim(),B="topic-"+R.replace(/\s+/g,"-").toLowerCase();F.push({id:B,title:R})}return F},[e,t]);return r.jsxs("div",{className:"top-nav-container",children:[r.jsx("div",{className:"nav-group",children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:a=>{const f=s.find(m=>m.id===a.target.value);f&&n(f)},disabled:b||s.length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:b?"載入中...":"📖 章節選擇"}),s.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(Y,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${!e||i.length===0?"disabled":""}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"topic-select",name:"topic-select",value:o,onChange:a=>y(a.target.value),disabled:!e||i.length===0,className:"custom-select",children:[r.jsx("option",{value:"",children:"💡 重點導覽"}),i.map(a=>r.jsx("option",{value:a.id,children:a.title},a.id))]}),r.jsx(Y,{className:"select-icon",size:16})]})}),r.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:r.jsxs("div",{className:"custom-select-wrapper",children:[r.jsxs("select",{id:"script-select",name:"script-select",value:(l==null?void 0:l.filename)||"",onChange:a=>{var m;const f=(e==null?void 0:e.examples)||((m=e==null?void 0:e.content)==null?void 0:m.examples);if(f){const x=f.find(j=>j.filename===a.target.value);x&&c(x)}},disabled:!e||!(e.examples||(k=e.content)!=null&&k.examples)||(e.examples||((d=e.content)==null?void 0:d.examples)||[]).length===0,className:"custom-select",children:[r.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var m;return[...(e==null?void 0:e.examples)||((m=e==null?void 0:e.content)==null?void 0:m.examples)||[]].sort((x,j)=>x.filename.localeCompare(j.filename,void 0,{numeric:!0,sensitivity:"base"})).map(x=>r.jsx("option",{value:x.filename,children:x.filename},x.filename))})()]}),r.jsx(Y,{className:"select-icon",size:16})]})})]})}const Ce=new Le,Te=u.memo(({chapter:s,bodyContent:e,onCodeClick:t,selectedTopicId:n,output:l,isRunning:c,plotImages:o})=>{const y=u.useRef(null),b=u.useMemo(()=>{var k,d;if(!s)return null;const i=(k=s.content)==null?void 0:k.intro;if(i){let a="";if(typeof i=="string")a=i;else if(typeof i=="object"){a=`# ${i.title||""}
...
try:
    ...
    for func in ['irr', 'npv', 'pmt', 'pv', 'rate', 'nper', 'fv', 'ppmt', 'ipmt']:
        if not hasattr(np, func) and hasattr(npf, func): setattr(np, func, getattr(npf, func))
                ...
                `)]),await e.yieldToUI(),e.update(95,"🔬 系統：正在安裝 SciPy 純 Python 計算引擎..."),await e.yieldToUI(),await t.runPythonAsync(Qe),e.update(98,"🚀 系統：正在啟動 Pymoo & QuantLib 虛擬層..."),await e.yieldToUI(),await Promise.all([t.runPythonAsync(Ue),t.runPythonAsync(Oe),t.runPythonAsync(ue),t.runPythonAsync(_e),t.runPythonAsync(We)]),e.update(99,"🛡️ 系統：權限校正與輸入掛鉤注入..."),await t.runPythonAsync(`
import builtins
import js
def custom_input(prompt = ""):
    try:
...
builtins.input = custom_input
            `),await e.yieldToUI(),K=t,$=null,e.finish("載入完成！正在進入主介面..."),t}catch(t){throw $=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),$)}async function Je(s,e,t=3e4){let n;const l=new Promise((c,o)=>{n=setTimeout(()=>{o(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([s.runPythonAsync(e),l])}finally{clearTimeout(n)}}async function Xe(s){if(s)try{await s.runPythonAsync(`
            import gc
import matplotlib.pyplot as plt
            plt.close('all')
            gc.collect()
                `)}catch{}}const ie=new Set;async function oe(s,e){!s||!e||ie.has(e)||ie.add(e)}async function Ze(s){if(s)try{await s.loadPackage("micropip");const e=s.pyimport("micropip"),t=["/pwa_FRM_Book1/wheels/pymoo-0.4.1-py3-none-any.whl","/pwa_FRM_Book1/wheels/pandas_datareader-0.10.0-py3-none-any.whl","/pwa_FRM_Book1/wheels/pyodide_http-0.2.2-py3-none-any.whl","/pwa_FRM_Book1/wheels/seaborn-0.13.2-py3-none-any.whl"];await e.install(t,{transient:!0}).catch(n=>{console.warn("preloadHeavyPackages pip install failed",n)})}catch(e){console.warn("preloadHeavyPackages error",e)}}async function et(s){try{const e=await s.runPythonAsync(`
import matplotlib.pyplot as plt
len(plt.get_fignums())
...
try:
    ...
    pass
      `)}catch{}return t}catch(e){return console.error("Failed to capture plots:",e),[]}}async function fe(s,e=!1){try{const t=e?"module://matplotlib_pyodide.wasm_backend":"AGG";await s.runPythonAsync(`
import matplotlib
import matplotlib.pyplot as plt
import warnings
import io
...
def _safe_save_figure(fig, buf):
    ...
    try:
        ...
        fig.savefig(buf, format='png', dpi=150, bbox_inches='tight', facecolor='white')
    `)}catch(t){console.error("✗ Matplotlib 初始化失敗:",t)}}async function tt(s){try{await s.runPythonAsync(`
import matplotlib.pyplot as plt
if len(plt.get_fignums()) > 0:
    plt.show()
    `)}catch(e){console.error("Failed to show plots:",e)}}function de(s){const e=s.message||String(s),t=[{pattern:/NameError: name '(.+)' is not defined/,format:n=>`❌ 變數錯誤：'${n[1]}' 未定義
...
• 逐行執行程式碼找出問題
• 使用 print() 輸出變數值
• 簡化程式碼，逐步測試`}class at{constructor(){this.metrics={},this.enabled=!0}start(e){this.enabled&&(this.metrics[e]={start:performance.now(),end:null,duration:null})}end(e){if(!this.enabled||!this.metrics[e])return 0;const t=performance.now(),n=this.metrics[e].start,l=t-n;return this.metrics[e].end=t,this.metrics[e].duration=l,this.log(e,l),l}log(e,t){const n=t<100?"⚡":t<1e3?"⏱️":"🐌",l=t<100?"color: green":t<1e3?"color: orange":"color: red";console.log(`%c${n} ${e}: ${t.toFixed(2)}ms`,l),t>1e3&&console.warn(`⚠️ ${e} 執行時間過長: ${t.toFixed(2)}ms`)}async measure(e,t){this.start(e);try{return await t()}finally{this.end(e)}}getMetric(e){return this.metrics[e]||null}getMetrics(){return{...this.metrics}}getStats(){const e=Object.values(this.metrics).filter(t=>t.duration!==null).map(t=>t.duration);return e.length===0?{count:0,total:0,average:0,min:0,max:0}:{count:e.length,total:e.reduce((t,n)=>t+n,0),average:e.reduce((t,n)=>t+n,0)/e.length,min:Math.min(...e),max:Math.max(...e)}}clear(e){e?delete this.metrics[e]:this.metrics={}}setEnabled(e){this.enabled=e}report(){const e=this.getStats();console.group("📊 效能報告"),console.log(`總計測量: ${e.count} 次`),console.log(`總時間: ${e.total.toFixed(2)}ms`),console.log(`平均時間: ${e.average.toFixed(2)}ms`),console.log(`最快: ${e.min.toFixed(2)}ms`),console.log(`最慢: ${e.max.toFixed(2)}ms`),console.groupEnd(),console.group("📋 詳細指標"),Object.entries(this.metrics).forEach(([t,n])=>{n.duration!==null&&console.log(`${t}: ${n.duration.toFixed(2)}ms`)}),console.groupEnd()}}const I=new at;I.setEnabled(!1);let ce=!1;function st(){if(!ce&&(ce=!0,"PerformanceObserver"in window)){new PerformanceObserver(l=>{const c=l.getEntries(),o=c[c.length-1];console.log("🎨 LCP:",o.renderTime||o.loadTime)}).observe({entryTypes:["largest-contentful-paint"]}),new PerformanceObserver(l=>{l.getEntries().forEach(o=>{console.log("⚡ FID:",o.processingStart-o.startTime)})}).observe({entryTypes:["first-input"]});let t=0;new PerformanceObserver(l=>{l.getEntries().forEach(o=>{o.hadRecentInput||(t+=o.value)}),console.log("📐 CLS:",t)}).observe({entryTypes:["layout-shift"]})}}const nt=u.lazy(()=>me(()=>import("./CodePreviewPanel-oKRZDTCG.js"),__vite__mapDeps([0,1,2,3]))),J={QuantLib:"QuantLib",arch:"arch",autograd:"autograd",chart_studio:"chart-studio",datetime:"datetime",lxml:"lxml",math:"math",matplotlib:"matplotlib",mcint:"mcint",mibian:"mibian",mpl_toolkits:"matplotlib",numpy:"numpy",numpy_financial:"wheels/numpy_financial-1.0.0-py3-none-any.whl",openpyxl:"openpyxl",pandas:"pandas",pandas_datareader:"wheels/pandas_datareader-0.10.0-py3-none-any.whl",plotly:"plotly",prettytable:"prettytable",pylab:"matplotlib",pymoo:"wheels/pymoo-0.4.1-py3-none-any.whl",pyodide_http:"wheels/pyodide_http-0.2.2-py3-none-any.whl",qpsolvers:"qpsolvers",requests:"requests","scikit-learn":"scikit-learn",scipy:"scipy",seaborn:"wheels/seaborn-0.13.2-py3-none-any.whl",sklearn:"scikit-learn",statsmodels:"statsmodels",sympy:"sympy",tabulate:"tabulate"},pe={requests:["certifi","charset_normalizer","idna","urllib3"],certifi:"wheels/certifi-2026.1.4-py3-none-any.whl",charset_normalizer:"wheels/charset_normalizer-3.4.4-py3-none-any.whl",idna:"wheels/idna-3.11-py3-none-any.whl",urllib3:"wheels/urllib3-2.6.3-py3-none-any.whl"},X=760;typeof window<"u"&&"serviceWorker"in navigator&&(async()=>{try{const s=`/pwa_FRM_Book1/manifest.webmanifest?t=${Date.now()}`;let e=null;try{const c=await fetch(s,{cache:"no-store"});c&&c.ok&&(e=await c.text())}catch{}if(!e)return;const t=localStorage.getItem("app_assets_manifest_text");if(t&&t===e)return;localStorage.setItem("app_assets_manifest_text",e);const n=await navigator.serviceWorker.getRegistrations();if(!n||n.length===0){localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),location.reload());return}for(const c of n)try{await c.update(),c.waiting&&c.waiting.postMessage({type:"SKIP_WAITING"})}catch(o){console.warn("SW update attempt failed:",o)}const l=()=>{localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),window.location.reload())};navigator.serviceWorker.addEventListener("controllerchange",l)}catch(s){console.warn("Version check/update failed:",s)}})();function rt(){const[s,e]=u.useState(null),[t,n]=u.useState(!0),[l,c]=u.useState(0),[o,y]=u.useState("初始化中..."),[b,i]=u.useState([]),[k,d]=u.useState(!0),[a,f]=u.useState(null),[m,x]=u.useState(null),[j,F]=u.useState(""),[T,R]=u.useState({}),{bodyContent:B}=Ie(a),[v,g]=u.useState(""),[E,C]=u.useState([]),[Q,U]=u.useState(!1),[Z,ge]=u.useState(!1),[A,ye]=u.useState(()=>{const _=localStorage.getItem("theme");return _==="dark"||!_&&!1}),[ee,H]=u.useState(X),[M]=u.useState(new Set),[te,ae]=u.useState(null),se=u.useRef(!1);u.useEffect(()=>{d(!0);const _=`/pwa_FRM_Book1/data/chapters_index.json?t=${Date.now()}`;fetch(_).then(p=>p.json()).then(p=>{p&&p.length>0&&i(p),d(!1)}).catch(p=>{console.error("Failed to load chapters index:",p),d(!1)})},[]);const he=async _=>{if(T[_])return T[_];try{d(!0);const p=await fetch(`/pwa_FRM_Book1/data/chapters_${_}.json?t=${Date.now()}`);if(!p.ok)throw new Error(`HTTP error! status: ${p.status}`);const q=await p.text();let z=null;try{z=JSON.parse(q)}catch{try{const P=q.replace(/\\(?!["\\/bfnrtu])/g,"\\\\");z=JSON.parse(P)}catch(P){throw new Error(`Failed to parse chapter data: ${P.message}`)}}return R(P=>({...P,[_]:z})),d(!1),z}catch(p){return console.error(`Failed to load chapter ${_}:`,p),d(!1),null}};u.useEffect(()=>{Ke((p,q)=>{c(p),y(q)}).then(p=>{e(p),n(!1),I.end("pyodide-init")}),st();const _=[];if("serviceWorker"in navigator){const p=setInterval(()=>{navigator.serviceWorker.getRegistrations().then(z=>{z.forEach(P=>P.update())})},36e5),q=()=>{};navigator.serviceWorker.addEventListener("controllerchange",q),_.push(()=>{clearInterval(p),navigator.serviceWorker.removeEventListener("controllerchange",q)})}if("storage"in navigator&&"estimate"in navigator.storage){const p=async()=>{try{const z=await navigator.storage.estimate();z.usage&&z.quota&&z.usage/z.quota*100>80&&console.warn("Storage usage is high (>80%). Consider cleaning up.")}catch(z){console.warn("Failed to check storage quota:",z)}};p();const q=setInterval(p,300*1e3);_.push(()=>clearInterval(q))}return()=>{_.forEach(p=>p())}},[]),u.useEffect(()=>{s&&!t&&Ze(s).then(()=>{se.current||(se.current=!0,console.warn("Background initialization complete"))}).catch(_=>console.error("Background loaded failed",_))},[s,t]),u.useEffect(()=>{localStorage.setItem("theme",A?"dark":"light"),document.documentElement.setAttribute("data-theme",A?"dark":"light")},[A]);const ne=async(_,p=!1)=>{var le;if(!s)return;const q=_.match(/^\s*(?:from|import)\s+([a-zA-Z0-9_]+)/gm);if(!q)return;if(/^\s*(?:from|import)\s+QuantLib\b/m.test(_)&&!M.has("QuantLib"))try{p||g(h=>h+`正在啟用 QuantLib 相容性墊片...
`),await s.runPythonAsync(ue),M.add("QuantLib"),p||g(h=>h+`✅ QuantLib 墊片已啟用。
`)}catch(h){console.warn("QuantLib shim injection failed:",h),p||g(w=>w+`⚠️ QuantLib 墊片啟用失敗，將嘗試繼續執行...
`)}const z=["sys","os","io","time","timeit","base64","json","datetime","math","re","warnings","builtins","types","random","csv","copy","collections","itertools","functools","pathlib","fractions","struct","operator","string","decimal","abc","enum","typing","textwrap"],P=["numpy","pandas","matplotlib","micropip","js","builtins","QuantLib","mcint","arch","mibian"],L=[...new Set(q.map(h=>{const w=h.trim().split(/\s+/);return w[0]==="from",w[1].split(".")[0]}))].filter(h=>!z.includes(h)&&!P.includes(h)).filter(h=>{var w;return!M.has(h)&&!((w=window.failedPackages)!=null&&w.has(h))});if(L.length===0)return;const D=[],O=[],V=new URL("/pwa_FRM_Book1/",window.location.origin).href,ze=new Set(["scipy","statsmodels","scikit-learn","sympy"]),W=h=>{if(h){if(typeof h=="string"&&(h.endsWith(".whl")||h.startsWith("http"))){O.push(h);return}ze.has(h)?D.push(h):O.push(h)}},re={sklearn:["scipy","scikit-learn"],"scikit-learn":["scipy"],statsmodels:["scipy"],sympy:[],seaborn:["matplotlib","pandas","scipy","statsmodels"],pandas_datareader:["requests"]};if(L.forEach(h=>{const w=J[h];w?(W(w.endsWith(".whl")?V+w:w),(pe[h]||[]).forEach(N=>{const G=pe[N]||N;W(G.endsWith(".whl")?V+G:G)})):W(h),re[h]&&re[h].forEach(S=>{if(!M.has(S)&&!P.includes(S)){const N=J[S]||S;W(N.endsWith(".whl")?V+N:N)}})}),D.length>0||O.length>0)try{const h=[...new Set(D)],w=[...new Set(O)];p||g(S=>S+`正在動態載入所需套件 [${L.join(", ")}]...
...
await micropip.install(${JSON.stringify(w)}, keep_going=True)
          `)),L.includes("pandas_datareader")&&await s.runPythonAsync(_e),L.includes("matplotlib")&&(await fe(s),te||ae("AGG")),L.forEach(S=>{M.add(S);const N=J[S];N&&!N.endsWith(".whl")&&M.add(N)}),p||g(S=>S+`✅ 套件載入完成。
`)}catch(h){if(console.warn("Dependency loading failed:",h),window.failedPackages||(window.failedPackages=new Set),L.forEach(w=>window.failedPackages.add(w)),!p){const w=h.message||String(h);if(w.includes("Can't find a pure Python 3 wheel")){const S=((le=w.match(/for: '([^']+)'/))==null?void 0:le[1])||"unknown";g(N=>N+`⚠️ 套件 "${S}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else g(S=>S+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},xe=async _=>{if(!(!s||Q||!_)){U(!0),g(`執行中...
`),C([]);try{a&&a.id&&await oe(s,a.id),await ne(_),I.start("run-code"),await Xe(s);const p=_.includes("matplotlib.widgets")||_.includes("Slider")||_.includes("Button");ge(p);const q=p?"module://matplotlib_pyodide.wasm_backend":"AGG";if(te!==q&&(await fe(s,p),ae(q)),await s.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),p){const P=document.getElementById("pyodide-plot-container");P&&(P.innerHTML="",window.document.pyodideMplTarget=P)}try{await Je(s,_)}catch(P){const L=await s.runPythonAsync("sys.stdout.getvalue()"),D=de(P);g((L?L+`
`:"")+D),U(!1),I.end("run-code");return}const z=await s.runPythonAsync("sys.stdout.getvalue()");if(g(z||"執行完成（無文字內容輸出 ）"),Z)await tt(s);else{const P=await et(s);C(P)}}catch(p){const q=de(p);g(q),console.error(p)}finally{U(!1),I.end("run-code")}}},be=async _=>{let p=_;if(_&&!_.content&&(p=await he(_.id)),!!p&&(f(p),x(null),F(""),g(""),C([]),p&&p.examples&&s)){const q=p.examples.map(z=>z.code).join(`
`);ne(q,!0)}};u.useEffect(()=>{s&&a&&a.id&&oe(s,a.id).catch(_=>console.error("Dataset lazy load failed",_))},[s,a]);const ve=_=>{x(_),H(X),g(""),C([])},we=_=>{x(_),H(X),g(""),C([])},ke=()=>{x(null),g(""),C([])},qe=t;return r.jsxs("div",{className:`app ${A?"dark":""}`,children:[r.jsxs("div",{className:"main-content",children:[r.jsxs("div",{className:"top-bar",children:[r.jsxs("div",{className:"top-bar-left",children:[r.jsx(Pe,{size:20,className:"logo-icon"}),r.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),r.jsx(Re,{chapters:b,currentChapter:a,bodyContent:B,onChapterSelect:be,currentScript:m,onScriptSelect:we,selectedTopicId:j,onTopicSelect:F,loading:k}),r.jsx("div",{className:"top-bar-right",children:r.jsx("button",{className:"theme-toggle",onClick:()=>ye(!A),title:A?"切換到亮色模式":"切換到暗色模式",children:A?r.jsx(Se,{size:20}):r.jsx(Ee,{size:20})})})]}),qe&&r.jsx("div",{className:"hydration-overlay",children:r.jsxs("div",{className:"hydration-card",children:[r.jsxs("div",{className:"hydration-header",children:[r.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),r.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),r.jsx("div",{className:"hydration-progress-container",children:r.jsx("div",{className:"hydration-progress-bar",style:{width:`${l}%`}})}),r.jsxs("div",{className:"hydration-status",children:[r.jsx("span",{children:o}),r.jsxs("span",{children:[l,"%"]})]})]})}),r.jsxs("div",{className:"panes-container",children:[r.jsx("div",{className:"content-pane",children:r.jsx(Te,{chapter:a,bodyContent:B,onCodeClick:ve,selectedTopicId:j,darkMode:A,output:v,isRunning:Q,plotImages:E,onClearOutput:()=>{g(""),C([])}})}),r.jsx("div",{className:`preview-pane${m?"":" preview-pane--hidden"}`,style:{width:m?`${ee}px`:0},children:m&&r.jsx(u.Suspense,{fallback:r.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:r.jsx(nt,{script:m,onClose:ke,onRun:xe,isRunning:Q,isLoading:t,output:v,images:E,isInteractive:Z,darkMode:A,width:ee,onResize:H})})})]})]}),r.jsx(Me,{pyodide:s}),r.jsx(De,{})]})}async function lt(){try{if(!("serviceWorker"in navigator))return;const s="frm_sw_cleanup_done_v1";if(localStorage.getItem(s))return;if(!navigator.serviceWorker.controller){localStorage.setItem(s,"1");return}console.info("[AUTO-CLEAN] Detected active Service Worker — cleaning caches and storage.");try{const e=await navigator.serviceWorker.getRegistrations();await Promise.all(e.map(t=>t.unregister().catch(()=>{}))),console.info("[AUTO-CLEAN] serviceWorker registrations unregistered.")}catch(e){console.warn("[AUTO-CLEAN] Failed to unregister service workers",e)}try{if("caches"in window){const e=await caches.keys();await Promise.all(e.map(t=>caches.delete(t).catch(()=>{}))),console.info("[AUTO-CLEAN] CacheStorage cleared:",e)}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear CacheStorage",e)}try{if("databases"in indexedDB){const e=await indexedDB.databases();await Promise.all(e.map(t=>indexedDB.deleteDatabase(t.name).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB databases deleted:",e.map(t=>t.name))}else{const e=["pyodide","emscripten-archives","idb-filesystem","file_storage"];await Promise.all(e.map(t=>indexedDB.deleteDatabase(t).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB fallback delete attempted for candidates.")}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear IndexedDB",e)}try{localStorage.clear(),sessionStorage.clear(),console.info("[AUTO-CLEAN] localStorage and sessionStorage cleared.")}catch(e){console.warn("[AUTO-CLEAN] Failed to clear storage",e)}try{localStorage.setItem(s,"1")}catch{}try{console.info("[AUTO-CLEAN] Reloading page to load fresh assets."),window.location.reload(!0)}catch(e){console.info("[AUTO-CLEAN] Reload skipped.",e)}}catch(s){console.warn("[AUTO-CLEAN] Unexpected error",s)}}lt().catch(()=>{});Ne.createRoot(document.getElementById("root")).render(r.jsx(je.StrictMode,{children:r.jsx(rt,{})}));
